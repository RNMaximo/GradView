const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG100', 'EM110', 'EM102', 'F_128', 'MA141', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM103', 'EM240', 'F_129', 'EM200', 'F_328', 'EM306', 'MA211', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'EM335', 'F_428', 'MA311', 'F_329', 'EM360', 'MC102']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM460', 'EM641', 'EM461', 'EM406', 'F_429', 'MA327', 'EM404', 'MS211']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM737', 'EM014', 'EM638', 'EM503', 'EM506', 'EM570', 'EM561', 'EM504']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM665', 'EM535', 'EM733', 'EM909', 'ET017', 'EM607', 'EM670']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM884', 'EM730', 'EM833', 'EM853', 'EM608', 'EM703', 'EM783', 'EM707']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM984', 'EM740', 'BE310', 'EM790', 'CE738', 'EM807', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM928', 'EM914', 'EM926', 'CE304']
		},
		'sem-10': {
			id: '10',
