const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MA111', 'MA141', 'MC102', 'MC009']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_128', 'F_129', 'MA211', 'MC202', 'MA327']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_328', 'F_329', 'ME323', 'MC302', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['ELET04', 'MS211', 'MC358', 'MC750', 'MC602']
		},
		'sem-5': {
			id: '5',
			subjects: ['MC536', 'MC426', 'MC458', 'MC404']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'MC437', 'MC504', 'MC558', 'MC346']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'MC626', 'MC832', 'MC658', 'MC732']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'MC714', 'MC833', 'CE839']
		},
		'sem-9': {
			id: '9',
	...
	eletivas: {
		...
		'elet-2': {
			...
			subjects: ['MC851', 'MC853', 'MC855', 'MC857', 'MC859', 'MC861', 'MC871', 'MC881', 'MC911'],
		},
		'elet-3': {
			credits: 4,
			hasRestrictions: true,
