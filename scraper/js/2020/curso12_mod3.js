const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV101', 'CV151', 'QG102', 'MA141', 'MA111', 'CV141', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['MA327', 'CV201', 'F_128', 'F_129', 'CV202', 'MA211', 'ME414', 'GM420']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV312', 'CV321', 'CV301', 'F_229', 'CV332', 'MA311', 'CV351', 'MS211']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV411', 'CV421', 'CV431', 'CV402', 'F_328', 'F_329', 'CV401', 'ELET04', 'CV450']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV511', 'CV501', 'CV532', 'CV522', 'CV531', 'CV521', 'CV541', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV612', 'CV613', 'CV622', 'CV631', 'CV621', 'CV633', 'CV632', 'CV641', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV713', 'CV712', 'CV722', 'CV714', 'CV702', 'CV721', 'CV701', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV822', 'CV813', 'CV814', 'CV823', 'CV821', 'CV811', 'CV832', 'CV831', 'CV812', 'CV841', 'ELET08']
		},
		'sem-9': {
			id: '9',
		...
		'sem-10': {
			id: '10',
			subjects: ['CV951', 'CV902', 'CV955', 'CV900', 'CV903']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['CV001', 'CV002', 'CV003', 'CV004', 'CV005', 'CV006', 'CV061', 'CV063', 'CV901', 'CV904', 'CV908', 'CV909', 'CV952', 'CV953', 'CV961', 'CV962', 'CV963', 'CV964'],
		},
		'elet-2': {
			credits: 7,
	...
	subjects: {
		...
		'CV961': {
			code: 'CV961',
			name: 'Tópicos Especiais em Gestão do Projeto e da Construção III',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
		...
		'CV962': {
			code: 'CV962',
			name: 'Tópicos Especiais em Gestão do Projeto e da Construção IV',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
		...
		'CV963': {
			code: 'CV963',
			name: 'Tópicos Especiais em Gestão do Projeto e da Construção V',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
		...
		'CV964': {
			code: 'CV964',
			name: 'Tópicos Especiais em Gestão do Projeto e da Construção VI',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
