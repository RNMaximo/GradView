const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['LE105', 'LE100', 'LE200', 'LE101', 'LE106', 'NC103']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC202', 'LE205', 'LE400', 'LE201', 'LE203', 'LE202', 'NC104']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'LE103', 'LE500', 'LE301', 'LE300', 'LE303', 'LE302']
		},
		'sem-4': {
			id: '4',
			subjects: ['EU502', 'EU503', 'LE401', 'LE404', 'LE408', 'LE402', 'LE409', 'LE405']
		},
		'sem-5': {
			id: '5',
			subjects: ['EU501', 'LE406', 'EU605', 'LE503', 'EU604', 'LE501', 'EU500', 'LE505', 'NC400', 'LE504']
		},
		'sem-6': {
			id: '6',
			subjects: ['LE609', 'LE600', 'EU602', 'LE608', 'LE602', 'ER600', 'LE704', 'ER201']
		},
		'sem-7': {
			id: '7',
			subjects: ['LE012', 'LE701', 'EU901', 'EU702', 'LE902', 'LE700', 'ELET07', 'LE703']
		},
		'sem-8': {
			id: '8',
			subjects: ['ER801', 'ER700', 'EU704', 'ELET08', 'LE804', 'LE802']
		},
		'sem-9': {
			id: '9',
			subjects: ['EU010', 'ER901', 'EU802', 'ELET09']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'ER011']
		}
	},
	...
	subjects: {
		...
		'LE200': {
			code: 'LE200',
			name: 'Química Geral',
			ementa: 'Estrutura atômica, configuração eletrônica, ligação química, forças intermoleculares, soluções e reações químicas.',
			semestre: 1,
			vector: {T:2, P:0, L:2, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: '',
			color: '#B946A8',
		...
		'LE409': {
			...
			ementa: 'Variáveis aleatórias discretas e contínuas. Variáveis aleatórias multidimensionais. Distribuições e amostrais. Introdução à teoria de estimação: estimadores pontuais e intervalos de confiança. Noções de amostragem. Teste de hipótese. Introdução à análise de variância. Testes de aderência. Tabelas de contingência. Exemplos de aplicação em engenharia.',
			semestre: 1,
			vector: {T:2, P:2, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['NC104'],
			color: '#A846B9',
