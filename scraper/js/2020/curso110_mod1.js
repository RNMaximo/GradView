const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL100', 'GL203', 'NC400', 'PG100']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'GL201', 'PG300', 'PG201', 'PG200']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'NC104', 'GL202', 'GL102', 'PG301']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL608', 'GL303', 'GL603', 'PG800', 'ER201', 'PG400']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG710', 'PG500', 'PG502', 'GL507', 'PG501']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL304', 'PG600', 'ER401', 'GL502', 'PG701']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL710', 'PG704', 'PG810', 'PG709', 'GL701', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['PG801', 'ELET08', 'GL801']
		}
	},
