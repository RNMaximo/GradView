const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EA772', 'EM230', 'MA111', 'MA141', 'F_128', 'F_129']
		},
		'sem-2': {
			id: '2',
			subjects: ['EA773', 'EM330', 'MA211', 'EA513', 'F_228', 'F_229']
		},
		'sem-3': {
			id: '3',
			subjects: ['MC102', 'EE300', 'MA327', 'EA611']
		},
		'sem-4': {
			id: '4',
			subjects: ['EA869', 'EE410', 'MA311', 'EE103', 'CE304']
		},
		'sem-5': {
			id: '5',
			subjects: ['ME323', 'EE530', 'EE400', 'EE521', 'EE301']
		},
		'sem-6': {
			id: '6',
			subjects: ['EA871', 'LA122', 'EA614', 'F_315', 'EE540']
		},
		'sem-7': {
			id: '7',
			subjects: ['EE531', 'EE881', 'MS211', 'EA616', 'EA619', 'EE754']
		},
		'sem-8': {
			id: '8',
			subjects: ['EA879', 'EE640', 'EA044', 'EE522', 'ET521', 'ET520']
		},
		'sem-9': {
			id: '9',
			subjects: ['EE641', 'EE882', 'EE610', 'EA721', 'EA722', 'ET621', 'ET620']
		},
		'sem-10': {
			id: '10',
			subjects: ['QG111', 'EA075', 'QG122', 'EE755', 'EM524', 'ET720']
		},
		'sem-11': {
			id: '11',
			subjects: ['EA076', 'EE833', 'EM312', 'CE738', 'ELET11']
		},
		'sem-12': {
			id: '12',
			subjects: ['ELET12', 'CE838', 'EM423']
		},
		'sem-13': {
			id: '13',
			subjects: ['ELET13', 'EA006', 'BE310']
		},
		'sem-14': {
			id: '14',
			subjects: ['ELET14']
	...
	subjects: {
		...
		'EE300': {
			...
			ementa: 'Introdução à teoria da relatividade restrita. A teoria cinética da matéria. Quantização da radiação, da carga elétrica e da energia. Modelos atômicos clássicos. Propriedades ondulatórias das partículas. Equação de Schrödinger. O átomo com muitos elétrons. A estrutura do núcleo atômico e reações nucleares. Partículas elementares. Moléculas.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
		...
		'EE103': {
			...
			ementa: 'Atividades de laboratório relacionadas ao conhecimento de Engenharia Elétrica adquiridos pelo aluno nas disciplinas do Curso até o 3º semestre.Obs.: Esta disciplina será ministrada quinzenalmente. Recomenda-se que seja cursada junto ao após EA611',
			semestre: 1,
			vector: {T:0, P:0, L:2, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['EA513'],
			color: '#B99C46',
		...
		'EE301': {
			...
			ementa: 'Medidas em condutores. Efeito da temperatura. Condução em eletrólitos. Condução e ruptura em materiais dielétricos. Difração e refração da Luz. Polarização e birrefringência. Espectrometria óptica. Efeito fotoelétrico e efeito Hall.Obs.: Esta disciplina será ministrada quinzenalmente.',
			semestre: 1,
			vector: {T:0, P:0, L:2, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['F_229'],
			color: '#809D46',
		...
		'EA616': {
			...
			ementa: 'Caracterização de sistemas lineares. Modelamento de processos dinâmicos contínuos e discretos no tempo. Transformada de Laplace e Transformada Z. Solução de Equações diferenciais lineares. Solução de equações a diferenças lineares. Estabilidade. Função de transferência. Resposta em frequência de sistemas contínuos e discretos no tempo. Representação de estado de sistemas contínuos e discretos no tempo. Introdução ao controle por realimentação.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['EA513', 'EE400', 'MA327'],
			color: '#80AB71',
			obligatory: true
		},
		'EA619': {
