const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GL101', 'GL100', 'NC103', 'NC400', 'GL604']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC100', 'GL201', 'ELET02', 'GL202', 'GL203']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL600', 'GL301', 'NC301', 'GL302', 'GL300']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL200', 'GL400', 'GL403', 'GL603', 'LE803', 'LE702']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL501', 'GL506', 'GL504', 'ELET05', 'GL505', 'GL502']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL605', 'GL602', 'GL607', 'GL606', 'ER200', 'GL601', 'GL900']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'PG709', 'GL701', 'PG701', 'PG703', 'PG704', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'GL801', 'PG802', 'PG809', 'ELET08', 'PG801']
		}
	},
