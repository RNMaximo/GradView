const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['FN104', 'BH131', 'BH132', 'F_105', 'FN101', 'FN103', 'BA132', 'HL111', 'MD223', 'FN102']
		},
		'sem-2': {
			id: '2',
			subjects: ['FN207', 'FN504', 'ELET02', 'FN203', 'FN205', 'HL201', 'FN209', 'HL221', 'FN710', 'FN208', 'BS280']
		},
		'sem-3': {
			id: '3',
			subjects: ['FN604', 'FN306', 'MD215', 'FN307', 'BF180', 'HL304', 'FN301', 'HL321', 'FN304', 'FN302', 'MD350']
		},
		'sem-4': {
			id: '4',
			subjects: ['FN408', 'FN904', 'FN401', 'HL832', 'FN400', 'HL311', 'FN404', 'FN437', 'FN409', 'FN413', 'MD410', 'FN420']
		},
		'sem-5': {
			id: '5',
		...
		'sem-7': {
			id: '7',
			subjects: ['FN705', 'FN743', 'FN742', 'FN502', 'FN744', 'FN736', 'FN206', 'FN701', 'FN745']
		},
		'sem-8': {
			id: '8',
			subjects: ['FN843', 'FN842', 'FN805', 'FN844', 'FN908', 'FN836', 'FN845']
		}
	},
	...
	subjects: {
		...
		'FN836': {
			...
			ementa: 'EMENTATriagem auditiva neonatal em lactentes. Avaliação do processamento auditivo em lactentes e crianças. Processo de seleção e adaptação de próteses auditivas el lactentes e crianças',
			semestre: 1,
			vector: {T:0, P:4, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['FN736', 'FN701'],
			color: '#46A282',
			obligatory: true
		},
		'FN842': {
