const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MA111', 'EM102', 'MA141', 'F_128', 'EM110', 'QG100']
		},
		'sem-2': {
			id: '2',
			subjects: ['ME414', 'EM306', 'EM200', 'MA211', 'F_328', 'EM103', 'EM240', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'EM335', 'MC102', 'F_428', 'MA311', 'EM360', 'F_329']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM404', 'EM406', 'MS211', 'MA327', 'EM461', 'EM460', 'EM641', 'F_429']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM504', 'EM506', 'EM503', 'EM638', 'EM561', 'EM570', 'EM014', 'EM737']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM607', 'EM535', 'EM909', 'EM733', 'EM670', 'EM665', 'ET017']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM707', 'EM730', 'EM608', 'EM703', 'EM783', 'EM884', 'EM833', 'EM853']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM807', 'BE310', 'EM790', 'ELET08', 'EM984', 'CE738', 'EM740']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE304', 'EM926', 'EM928', 'EM105', 'ELET09']
		},
		'sem-10': {
			id: '10',
