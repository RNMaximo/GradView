const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV151', 'CV111', 'CV101', 'MA141', 'MC102', 'MA111', 'CV141', 'QG102']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'MA327', 'F_128', 'CV201', 'F_129', 'ME414', 'MA211', 'CV202']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'CV312', 'CV321', 'MS211', 'F_229', 'CV301', 'CV351', 'CV332']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV422', 'CV411', 'F_328', 'CV421', 'F_329', 'CV431', 'CV401', 'CV450']
		},
		'sem-5': {
			id: '5',
		...
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV621', 'CV631', 'CV622', 'CV632', 'CV641', 'CV633', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV714', 'CV713', 'CV721', 'CV702', 'CV701', 'CV722', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV813', 'CV812', 'CV814', 'CV811', 'CV823', 'CV821', 'CV832', 'CV831', 'CV841', 'ELET08', 'CV822']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV936', 'CV954', 'CV932', 'CV076', 'CV930', 'CV933', 'ELET09']
		},
		'sem-10': {
			id: '10',
