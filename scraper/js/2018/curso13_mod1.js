const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['TA109', 'QG101', 'MC102', 'F_128', 'MA141', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['QA213', 'QO427', 'TA221', 'F_228', 'MA211', 'QF331']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'BM320', 'TA322', 'TA332', 'F_328', 'TA331']
		},
		'sem-4': {
			id: '4',
			subjects: ['CE138', 'ET016', 'TA411', 'TA421', 'MS211', 'TA431', 'ME414']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA513', 'TA542', 'TA514', 'TA521', 'TA516', 'TA534', 'TA541']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA610', 'TA619', 'TA615', 'TA622', 'TA620', 'TA611', 'TA641', 'TA631']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA724', 'TA017', 'TA716', 'TA722', 'TA824', 'TA731', 'TA623', 'TA737', 'TA734']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA836', 'TA832', 'TA920', 'TA826', 'TA736', 'TA030', 'TA831']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA932', 'TA741', 'TA927', 'TA912', 'TA023', 'TA035']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA046', 'TA909', 'TA009']
		}
	},
