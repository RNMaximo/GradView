const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG102', 'CV111', 'CV141', 'CV101', 'MA141', 'MA111', 'MC102', 'CV151']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV202', 'GM420', 'MA327', 'MA211', 'CV201', 'ME414', 'F_128', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV332', 'MA311', 'CV312', 'CV321', 'CV351', 'MS211', 'F_229', 'CV301']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV450', 'CV411', 'CV402', 'CV422', 'CV401', 'CV421', 'F_328', 'CV431', 'F_329']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV541', 'CV521', 'CV522', 'ELET05', 'CV532', 'CV531']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'CV612', 'CV613', 'CV621', 'CV633', 'CV622', 'CV631', 'CV641', 'CV632']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV714', 'CV713', 'CV721', 'CV701', 'CV722', 'CV741', 'CV702']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'CV814', 'CV811', 'CV813', 'CV831', 'CV812', 'CV823', 'CV821', 'CV822', 'CV832', 'CV841']
		},
		'sem-9': {
			id: '9',
