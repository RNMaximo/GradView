const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV141', 'QG102', 'CV101', 'MA141', 'MA111', 'CV151', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV202', 'MA211', 'GM420', 'CV201', 'ME203', 'F_128', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV311', 'CV312', 'CV351', 'CV321', 'MS211', 'CV301', 'CV332', 'F_229']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV411', 'CV422', 'CV431', 'CV402', 'CV421', 'CV401', 'F_328', 'F_329', 'CV450']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV511', 'CV541', 'CV521', 'CV522', 'CV531', 'CV532', 'CV501', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV612', 'CV621', 'CV613', 'CV641', 'CV622', 'CV632', 'CV631', 'ELET06', 'CV633']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV721', 'CV722', 'CV702', 'CV741', 'CV714', 'CV701']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV831', 'CV813', 'CV814', 'CV821', 'CV822', 'CV823', 'CV832', 'CV812', 'ELET08', 'CV811', 'CV841']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV951', 'CV921', 'CV922', 'CV954']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV923', 'ELET10', 'CV955']
		}
	},
	...
	subjects: {
		...
		'CV087': {
			...
			ementa: 'Posicionamento por satélite, método fotográfico, sistema laser, altimetria por radar. Sistemas Geodésicos de referência: sistema cartesiano terrestre, sistema cartesiano celeste, catálogo celeste de coordenadas e catálogo terrestre de coordenadas (IRTF). O sistema GNSS: estrutura dos satélites e dos sinais. Medições com os códigos. Uso da fase de batimento da portadora. O problema da ambiguidade: métodos de resolução. Combinação Linear das medições de fase nas duas portadoras. O GNSS e a altimetria.',
			semestre: 1,
			vector: {T:1, P:0, L:1, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['CV321'],
			color: '#A2B946',
