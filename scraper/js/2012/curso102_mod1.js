const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['LE106', 'NC102', 'LE103', 'LE101', 'LE105', 'NC101', 'LE100']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC202', 'LE202', 'LE200', 'LE303', 'ER200', 'LE204', 'LE203', 'LE201', 'LE205']
		},
		'sem-3': {
			id: '3',
			subjects: ['LE302', 'NC100', 'GL301', 'LE400', 'NC400', 'LE300', 'LE301']
		},
		'sem-4': {
			id: '4',
			subjects: ['NC300', 'GL200', 'LE403', 'LE401', 'LE402', 'ELET04', 'LE408', 'LE406']
		},
		'sem-5': {
			id: '5',
			subjects: ['NC200', 'LE503', 'GL604', 'LE500', 'LE501', 'ER500', 'LE504']
		},
		'sem-6': {
			id: '6',
			subjects: ['LE608', 'LE604', 'LE607', 'LE600', 'LE602', 'LE012', 'ER602', 'NC500', 'ELET06', 'LE704']
		},
		'sem-7': {
			id: '7',
			subjects: ['LE705', 'LE902', 'ER700', 'LE703', 'ELET07', 'LE700', 'ER701', 'LE701']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'LE900', 'LE801', 'ER808', 'GL601', 'LE901']
		},
		'sem-9': {
			id: '9',
			subjects: ['ER900', 'ER901', 'ELET09', 'ER902']
		},
		'sem-10': {
			id: '10',
			subjects: ['ER011', 'ELET10', 'ER012']
		}
	},
