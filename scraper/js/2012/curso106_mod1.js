const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC101', 'GL101', 'NC102', 'GL100', 'GL604', 'NC400']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL203', 'GL202', 'NC202', 'GL201', 'NC300']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL300', 'GL600', 'GL301', 'NC100', 'GL302']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL200', 'GL603', 'GL403', 'GL400', 'LE702', 'LE803']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL501', 'GL502', 'GL504', 'GL506', 'NC200', 'GL505']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL602', 'ER200', 'GL606', 'GL607', 'GL605', 'GL601', 'NC500']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'PG709', 'PG701', 'GL701', 'ELET07', 'PG704', 'PG703']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'GL801', 'PG802', 'ELET08', 'PG801', 'PG809']
		}
	},
