const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC102', 'MA111', 'MA141', 'QG101', 'TA109', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['QF331', 'QO427', 'MA211', 'QA213', 'TA221', 'F_228']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA331', 'TA332', 'F_328', 'BM320', 'TA322', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['MS211', 'ME414', 'ET016', 'TA411', 'TA421', 'CE138', 'TA431']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA541', 'TA513', 'TA514', 'TA516', 'TA521', 'TA534', 'TA542']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA610', 'TA619', 'TA615', 'TA620', 'TA611', 'TA622', 'TA641', 'TA631']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA017', 'TA716', 'TA724', 'TA623', 'TA824', 'TA722', 'TA737', 'TA731', 'TA734']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA836', 'TA736', 'TA832', 'TA920', 'TA826', 'TA831', 'TA030']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA741', 'TA023', 'TA932', 'TA927', 'TA912', 'TA035']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA046', 'TA009', 'TA909']
		}
	},
