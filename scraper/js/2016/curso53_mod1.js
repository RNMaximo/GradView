const catalogue = {
	...
	semesters: {
		...
		'sem-2': {
			id: '2',
			subjects: ['F_229', 'F_228', 'GE406', 'GN208', 'GN207', 'MA141', 'GN107']
		},
		'sem-3': {
			id: '3',
			subjects: ['BD101', 'GN101', 'GE502', 'GE601', 'F_329', 'F_328', 'MA211']
		},
		'sem-4': {
			id: '4',
			subjects: ['GF410', 'LA122', 'GE402', 'GN304', 'GE407', 'QF331', 'ME414', 'GN105']
		},
		'sem-5': {
			id: '5',
			subjects: ['GF508', 'LA242', 'GE506', 'GE503', 'GF303', 'CV323', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['GE801', 'GE603', 'GE606', 'GE511', 'GE117', 'GN301', 'GF503']
		},
		'sem-7': {
			id: '7',
			subjects: ['GE802', 'GE704', 'GE708', 'ELET07', 'GE707', 'GE703', 'GE702']
		},
		'sem-8': {
			id: '8',
			subjects: ['GE706', 'GE711', 'GE803', 'GE805', 'GE806', 'ELET08', 'GE804']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'GE910', 'GE901', 'GE602', 'GE904', 'GE903']
		},
		'sem-10': {
			id: '10',
			subjects: ['GE007', 'GE001']
		}
	},
	...
	subjects: {
		...
		'GE806': {
			...
			ementa: 'Constituição, classificação e propriedades dos solos. Compressibilidade e adensamento, Resistência ao cisalhamento e empuxos da terra. Maciços rochosos e sua compartimentação. Alteração e alterabilidade de rochas. Água nos maciços rochosos. Taludes, fundações e aberturas subterrâneas. Trabalhos de campo e elaboração de relatório.',
			semestre: 1,
			vector: {T:2, P:1, L:1, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['GE601'],
			color: '#46B982',
