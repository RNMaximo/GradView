const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL100', 'GL604', 'NC400', 'GL101']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL203', 'GL201', 'NC100', 'ELET02', 'GL202']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL300', 'GL301', 'NC301', 'GL302', 'GL600']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL200', 'LE803', 'GL400', 'GL403', 'GL603', 'LE702']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL501', 'ELET05', 'GL506', 'GL504', 'GL505', 'GL502']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL602', 'GL900', 'GL607', 'GL605', 'ER200', 'GL601', 'GL606']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'AG706', 'GL701', 'AG702', 'ELET07', 'AG701', 'AG703']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'GL801', 'ELET08', 'AG800', 'AG805', 'AG801']
		}
	},
