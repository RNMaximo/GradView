const catalogue = {
	...
	semesters: {
		...
		'sem-4': {
			id: '4',
			subjects: ['MA044', 'F_428', 'F_315', 'F_429', 'QG102', 'QG101']
		},
		'sem-5': {
			id: '5',
			subjects: ['F_502', 'F_520', 'BS580', 'F_589', 'F_540']
		},
		'sem-6': {
			id: '6',
			subjects: ['F_320', 'F_620', 'BS681', 'F_550', 'F_689']
		},
		'sem-7': {
			id: '7',
			subjects: ['F_604', 'F_740', 'F_752', 'F_758', 'F_790']
		},
		'sem-8': {
			id: '8',
			subjects: ['F_837', 'ELET08', 'F_853', 'F_854', 'F_852']
		},
		'sem-9': {
			id: '9',
			subjects: ['MD947', 'MD760']
		},
		'sem-10': {
			id: '10',
			subjects: ['MD948']
	...
	subjects: {
		...
		'F_790': {
			...
			ementa: 'Percepção visual humana; imagem digital; processamento de imagem; transformada de Fourier contínua e discreta; tranformada de Laplace; filtragem de imagens; transformações geométricas; reconstrução de imagens através de projeções.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['AA200'],
			color: '#46B996',
