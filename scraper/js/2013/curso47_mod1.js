const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CE172', 'CE105', 'CE142', 'CE141', 'CE191']
		},
		'sem-2': {
			id: '2',
			subjects: ['CE272', 'CE242', 'CE205', 'MA111', 'CE291']
		},
		'sem-3': {
			id: '3',
			subjects: ['CE305', 'CE372', 'CE112', 'CE262', 'CE391']
		},
		'sem-4': {
			id: '4',
			subjects: ['CE405', 'CE342', 'CE472', 'ME414', 'CE362', 'CE302']
		},
		'sem-5': {
			id: '5',
			subjects: ['CE113', 'CE572', 'CE462', 'CE491', 'CE482']
		},
		'sem-6': {
			id: '6',
			subjects: ['CE323', 'CE671', 'CE562', 'CE591', 'CE582']
		},
		'sem-7': {
			id: '7',
			subjects: ['CE423', 'CE592', 'CE672', 'CE853', 'CE682']
		},
		'sem-8': {
			id: '8',
			subjects: ['CE442', 'CE791', 'CE593', 'CE625', 'CE792', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'CE542', 'CE725']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'CE825']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['CE181', 'CE243', 'CE281', 'CE351', 'CE414', 'CE451', 'CE505', 'CE526', 'CE539', 'CE623', 'CE641', 'CE651', 'CE652', 'CE653', 'CE654', 'CE712', 'CE723', 'CE731', 'CE742', 'CE751', 'CE753', 'CE782', 'CE783', 'CE823', 'CE841', 'CE856', 'CE857', 'CE858', 'CE859', 'CE860', 'CE872', 'CE891', 'CE892', 'CE900', 'CE923', 'CE939'],
		},
		'elet-2': {
			credits: 12,
	...
	subjects: {
		...
		'CE372': {
			...
			ementa: 'Determinação do emprego e da produção no modelo clássico. Princípio da demanda efetiva. Determinação da produção, emprego e renda em Keynes. Determinação da renda em Kalecki.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
		...
		'CE342': {
			...
			ementa: 'Aplicações em modelos macroeconômicos de economia fechada e aberta: IS-LM, oferta e demanda agregada, curva de Phillips. Aplicações em modelos macroeconômicos híbridos utilizados por bancos centrais.',
			semestre: 1,
		...
		'CE423': {
			code: 'CE423',
			name: 'Econometria I',
			ementa: 'Econometria e economia. Regressão Linear Múltipla. Variáveis Binárias. Violação das Hipóteses. Equações Simultâneas. Séries Temporais: Estacionariedade, Processo Auto-Regressivo Média Móvel. Raiz Unitária e Cointegração.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
		...
		'CE442': {
			...
			ementa: 'Estimando e testando hipóteses em modelos de regressão linear. Simulação de modelos. Desenvolvimento de modelos de séries temporais. Aplicações em economia.',
			semestre: 1,
			vector: {T:0, P:0, L:2, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['CE423'],
			color: '#46B97C',
