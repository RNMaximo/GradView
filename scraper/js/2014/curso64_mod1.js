const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC001', 'CS104', 'CS100', 'CS102', 'CS101', 'CS103', 'CS105']
		},
		'sem-2': {
			id: '2',
			subjects: ['CS200', 'CS201', 'CS204', 'CS205', 'CS203', 'CS202']
		},
		'sem-3': {
			id: '3',
			subjects: ['CS301', 'CS300', 'CS039', 'CS306', 'CS305', 'CS303', 'CS304', 'CS302']
		},
		'sem-4': {
			id: '4',
			subjects: ['CS405', 'CS400', 'CS040', 'CS402', 'CS403', 'CS401', 'CS404', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['CS500', 'CS502', 'CS503', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06']
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['CS001', 'CS005', 'CS041', 'CS042', 'CS043', 'CS044', 'CS045', 'CS046', 'CS047', 'CS060', 'CS061', 'CS062', 'CS063', 'CS064', 'CS065', 'CS066', 'CS067', 'CS068', 'CS069', 'CS070', 'CS071', 'CS072'],
		},
		'elet-2': {
			credits: 28,
			hasRestrictions: true,
			subjects: ['AR130', 'CS007', 'CS009', 'CS011', 'CS012', 'CS013', 'CS014', 'CS015', 'CS017', 'CS018', 'CS020', 'CS025', 'CS026', 'CS027', 'CS028', 'CS029', 'CS030', 'CS031', 'CS032', 'CS033', 'CS034', 'CS035', 'CS036', 'CS037', 'CS038', 'CS043', 'CS049', 'CS050', 'CS052', 'CS053', 'CS055', 'CS056', 'CS057', 'CS058', 'CS700', 'CS701', 'CS702', 'CS703', 'CS704', 'CS705', 'CS706', 'CS707', 'CS708', 'CS709', 'CS800', 'CS801'],
		},
		'elet-3': {
			credits: 12,
