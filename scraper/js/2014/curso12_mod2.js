const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV101', 'MA141', 'CV141', 'MC102', 'MA111', 'QG102', 'CV151']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'MA211', 'CV201', 'CV202', 'F_129', 'F_128', 'ME203']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV311', 'CV312', 'CV321', 'CV332', 'MS211', 'CV301', 'F_229', 'CV351']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV431', 'CV411', 'CV402', 'CV421', 'CV422', 'F_329', 'F_328', 'CV401', 'CV450']
		},
		'sem-5': {
			id: '5',
		...
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV621', 'CV622', 'CV633', 'CV632', 'CV631', 'CV641', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV713', 'CV712', 'CV721', 'CV714', 'CV722', 'CV702', 'CV701', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV841', 'ELET08', 'CV813', 'CV814', 'CV821', 'CV823', 'CV822', 'CV832', 'CV812', 'CV831', 'CV811']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV912', 'CV911', 'CV916', 'CV954', 'ELET09']
		},
		'sem-10': {
			id: '10',
