const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AC120', 'AC109', 'AC113', 'AC129', 'AC142', 'AC110', 'AC148', 'AC311']
		},
		'sem-2': {
			id: '2',
			subjects: ['AC150', 'AC213', 'AC209', 'AC170', 'AC242', 'AC316', 'AC248', 'AC411', 'AC218']
		},
		'sem-3': {
			id: '3',
			subjects: ['AC305', 'AC420', 'AC317', 'AC320', 'AC315', 'AC340', 'AC511']
		},
		'sem-4': {
			id: '4',
			subjects: ['AC405', 'AC611', 'AC318', 'ELET04', 'AC415', 'AC319', 'AC440']
		},
		'sem-5': {
			id: '5',
		...
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'AC121', 'AC667', 'AC666']
		},
		'sem-7': {
			id: '7',
			subjects: ['AC777', 'AC778', 'AC321']
		},
		'sem-8': {
			id: '8',
			subjects: ['AC888', 'AC889', 'AC887', 'AC890']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['AC001', 'AC002', 'AC003', 'AC004', 'AC105', 'AC112', 'AC143', 'AC160', 'AC205', 'AC212', 'AC219', 'AC221', 'AC229', 'AC243', 'AC260', 'AC270', 'AC280', 'AC325', 'AC350', 'AC360', 'AC370', 'AC425', 'AC460'],
		},
		'elet-2': {
			credits: 4,
			hasRestrictions: true,
