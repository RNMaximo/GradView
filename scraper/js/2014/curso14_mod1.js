const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['DM012', 'DM011', 'DB011', 'DM013', 'DS011']
		},
		'sem-2': {
			id: '2',
			subjects: ['DM024', 'DM021', 'DB021', 'DM022']
		},
		'sem-3': {
			id: '3',
			subjects: ['DM035', 'DM034', 'DM031', 'DM033', 'DM036', 'DM032']
		},
		'sem-4': {
			id: '4',
			subjects: ['DM045', 'DM041', 'DC041', 'DM046', 'DM042']
		},
		'sem-5': {
			id: '5',
			subjects: ['DM051', 'DC051', 'DM057', 'DM052']
		},
		'sem-6': {
			id: '6',
			subjects: ['DS062', 'DM068', 'DC061', 'DM067', 'DS061']
		},
		'sem-7': {
			id: '7',
			subjects: ['DM074', 'DM078', 'DC071', 'DS071']
		},
		'sem-8': {
			id: '8',
			subjects: ['DC081', 'DM084', 'DM083']
		},
		'sem-9': {
			id: '9',
	...
	subjects: {
		...
		'DM011': {
			code: 'DM011',
			name: 'Cárie I',
			ementa: 'Programa integrado de Anatomia, Histologia e Bioquímica, para o estudo da anatomia dos músculos da face, lábios, palato e língua, da mastigação, A.T.M., boca e anexos e a histologia e histofisiologia das estruturas moles da boca e anexos, da articulação temporomandibular e dos aspectos embriológicos, microscópicos e bioquímicos das estruturas dentais e tecidos de sustentação.',
			semestre: 1,
		...
		'DB021': {
			code: 'DB021',
			name: 'Biociências II',
			ementa: 'Conhecer as estruturas macro e microscópica e função do sistema nervoso autônomo, sistemas cardiovascular, respiratório, digestório, urinário, endócrino e reprodutor; conhecimento do equilíbrio energético, metabolismo e termoregulação; compreender o mecanismo de ação de drogas no organismo humano, através do estudo da farmacocinética, farmacodinâmica, ação de drogas sobre o sistema nervoso central e sistema nervoso autônomo.',
			semestre: 1,
			vector: {T:8, P:0, L:8, O:0, D:0, HS:16, SL:16, C:16},
			requisitos: '',
			color: '#46B9B9',
		...
		'DM033': {
			...
			ementa: 'Programa integrado de Cirurgia, Anatomia e Farmacologia para o estudo da anatomia do sistema arterial, venoso e linfático da cabeça e do pescoço, conhecimento dos princípios de biossegurança, antissépticos e desinfetantes, equipamentos, instrumentos e materiais necessários à realização de exodontias e conhecimento sobre a anatomia do nervo trigêmeo e suas relações morfo-funcionais aplicadas à prática odontológica.',
			semestre: 1,
			vector: {T:2, P:0, L:2, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['DM013'],
			color: '#9846B9',
		...
		'DM036': {
			...
			ementa: 'Programa de radiologia para o estudo das técnicas existentes para a realização de radiografias intra-bucais, adquirir noções de interpretação das estruturas maxilo-mandibulares, assim como estudar filmes e processamento radiográfico e soluções processadoras.',
			semestre: 1,
		...
		'DM042': {
			...
			ementa: 'Programa integrado de Patologia e Semiologia e Fisiologia para o estudo dos princípios de patologia do aparelho circulatório, características das lesões buco-dentais e analisar seu desenvolvimento e o prognóstico, considerando o dignóstico e o tratamento indicado.',
			semestre: 1,
		...
		'DM068': {
			...
			semestre: 1,
			vector: {T:4, P:0, L:3, O:0, D:0, HS:7, SL:7, C:7},
			requisitos: '',
			color: '#4657B9',
			obligatory: true
		},
