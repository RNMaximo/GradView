const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV151', 'CV101', 'CV111', 'MA141', 'MA111', 'CV141', 'QG102', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'MA327', 'CV201', 'MA211', 'ME414', 'F_128', 'CV202', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV321', 'CV351', 'CV312', 'MA311', 'MS211', 'CV301', 'CV332', 'F_229']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV421', 'CV401', 'CV411', 'CV431', 'F_328', 'F_329', 'CV450', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV521', 'CV522', 'CV532', 'CV541', 'CV531', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV621', 'CV622', 'CV631', 'CV632', 'CV641', 'CV633', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV714', 'CV721', 'CV722', 'CV701', 'CV702', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV831', 'CV813', 'CV814', 'CV812', 'CV811', 'CV823', 'CV832', 'CV822', 'CV821', 'ELET08', 'CV841']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV945', 'CV951', 'CV954', 'CV942', 'CV941']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'CV955', 'CV943', 'CV984']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['CV040', 'CV041', 'CV042', 'CV044', 'CV045', 'CV046', 'CV047', 'CV048', 'CV049', 'CV069', 'CV940', 'CV946', 'CV947', 'CV948', 'CV949', 'CV952', 'CV953', 'CV956', 'CV957', 'CV981', 'CV982', 'CV983'],
		},
		'elet-2': {
			credits: 7,
	...
	subjects: {
		...
		'CV981': {
			code: 'CV981',
			name: 'Tópicos em Saneamento Ambiental III',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
		...
		'CV982': {
			code: 'CV982',
			name: 'Tópicos em Gestão Ambiental III',
			ementa: 'A ementa desta disciplina será definida por ocasião de seu oferecimento.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
		...
		'CV983': {
			code: 'CV983',
			name: 'Seminário em Gestão e Saneamento Ambiental II',
			ementa: 'Organização de Seminários apresentados por especialistas e/ou pesquisadores convidados a expor sobre temas específicos de interesse em Saneamento e Ambiente. Promover palestras e discussões sobre propostas de epsquisas desenvolvidas pelos pesquisadores da pós-graduação e sobre artigos científicos correlatos recentes.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: ['AA440'],
			color: '#B946A6',
