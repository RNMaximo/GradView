const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GL100', 'NC103', 'GL101', 'NC400', 'PG100']
		},
		'sem-2': {
			id: '2',
		...
		'sem-3': {
			id: '3',
			subjects: ['GL301', 'NC301', 'GL202', 'PG300', 'PG301']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL400', 'ER401', 'GL603', 'PG800', 'ER201', 'PG400']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG502', 'PG500', 'GL502', 'PG704', 'PG501']
		},
		'sem-6': {
			id: '6',
			subjects: ['NC100', 'PG600', 'PG701', 'GL608', 'PG801', 'GL900']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'GL701', 'GL700', 'PG709', 'GL601', 'PG710']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL801', 'GL800', 'ELET08', 'PG810']
		}
	},
