const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV151', 'CV101', 'MA111', 'MA141', 'MC102', 'CV141', 'QG102']
		},
		'sem-2': {
			id: '2',
			subjects: ['MA327', 'GM420', 'CV201', 'MA211', 'F_129', 'F_128', 'CV202', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'CV312', 'CV321', 'MS211', 'CV301', 'F_229', 'CV332', 'CV351']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV422', 'CV411', 'CV402', 'CV421', 'F_329', 'F_328', 'CV431', 'CV450', 'CV401']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV511', 'CV521', 'CV522', 'CV501', 'CV532', 'CV531', 'CV541', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV621', 'CV622', 'CV631', 'CV633', 'CV632', 'CV641', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV713', 'CV712', 'CV714', 'CV721', 'CV722', 'CV702', 'CV741', 'CV701']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV812', 'CV813', 'CV814', 'CV811', 'CV821', 'CV823', 'CV832', 'ELET08', 'CV822', 'CV841', 'CV831']
		},
		'sem-9': {
			id: '9',
