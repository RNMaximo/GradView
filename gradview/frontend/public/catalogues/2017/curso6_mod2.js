const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MS380', 'BZ183', 'BE180', 'BC182', 'BT181', 'BG180', 'QG107']
		},
		'sem-2': {
			id: '2',
			subjects: ['BB281', 'F_107', 'BG200', 'BC282', 'BH282', 'BG282', 'BA281', 'BZ280', 'BT281']
		},
		'sem-3': {
			id: '3',
			subjects: ['BB381', 'BF381', 'ELET03', 'BI381', 'BG380', 'BM382', 'BZ380', 'BT382']
		},
		'sem-4': {
			id: '4',
			subjects: ['BZ480', 'BF481', 'ELET04', 'BE480', 'BH420', 'BV481', 'BG480', 'BT482']
		},
		'sem-5': {
			id: '5',
			subjects: ['BP582', 'ELET05', 'GM280', 'BH520', 'BV581', 'BT201']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'GM450', 'BD520']
		},
		'sem-7': {
			id: '7',
			subjects: ['BL300', 'ELET07', 'BD621']
		},
		'sem-8': {
			id: '8',
	...
	eletivas: {
		...
		'elet-2': {
			...
			subjects: ['BB017', 'BB018', 'BB585', 'BC680', 'BC692', 'BE781', 'BE782', 'BF586', 'BF587', 'BG580', 'BG582', 'BH382', 'BH584', 'BH586', 'BH684', 'BI583', 'BM584', 'BM681', 'BM682', 'BP580', 'BP590', 'BP670', 'BP915', 'BT582', 'BT595', 'BT597', 'BT682', 'BT685', 'BT792', 'BT916', 'BV586', 'BV587', 'BV782', 'BV880', 'BV881', 'BV882', 'BV884', 'BV886', 'BV888', 'BV916', 'BV925', 'BZ587', 'BZ599', 'BZ680', 'BZ817', 'FR725'],
		},
		'elet-3': {
			credits: 15,
			hasRestrictions: true,
			subjects: ['BA581', 'BA582', 'BA583', 'BB586', 'BC590', 'BC690', 'BC695', 'BC698', 'BC699', 'BD---', 'BE200', 'BE582', 'BE583', 'BE584', 'BE585', 'BE586', 'BE587', 'BE589', 'BE593', 'BE599', 'BF590', 'BG585', 'BG691', 'BH555', 'BH685', 'BP581', 'BP584', 'BV885', 'FA001', 'FA733', 'FA874', 'GE801', 'GE913', 'GE916', 'GN101'],
		},
		'elet-4': {
			credits: 4,
			hasRestrictions: true,
	...
	subjects: {
		...
		'BC680': {
			...
			ementa: 'Temas de destaque atual sobre organelas celulares, metodologias de estudo e/ou funções celulares.',
			semestre: 1,
			vector: {T:1, P:3, L:0, O:0, D:0, HS:4, SL:4, C:4},
		...
		'BC699': {
			...
			requisitos: ['BC182', 'BG380', 'BC282', 'AA200'],
			color: '#61B957',
			obligatory: false
		},
		'BC700': {
		...
		'BE585': {
			...
			ementa: 'A disciplina abordará temas em Ecologia de Organismos, populaões, comunidades ou ecossistemas.',
			semestre: 1,
			vector: {T:2, P:2, L:0, O:0, D:0, HS:4, SL:2, C:4},
			requisitos: '',
			color: '#46A0B9',
		...
		'BV882': {
			...
			ementa: 'Assuntos que envolvem a fisiologia vegetal aplicada serão abordados na disciplina, que terá palestras de especialistas em temas como caracterização do ambiente, nutrição de plantas, genética, biologia molecular, interação planta-ambiente e respostas fisiológicas de plantas em condições limitantes. Os alunos participarão da disciplina conduzindo seminários e elaborando relatórios sobre as palestras ministradas.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:2, D:0, HS:4, SL:2, C:4},
			requisitos: ['BV481'],
			color: '#4673B9',
		...
		'BV884': {
			...
			ementa: 'Metabolismo de carbono, nitrogênio e secundário em plantas sob estresse abiótico e biótico. Importância do sistema antioxidante e a sinalização em situações limitantes também serão abordadas, assim como a atenuação dos efeitos de estresses pela interação das plantas com microrganismos.',
			semestre: 1,
			vector: {T:2, P:0, L:4, O:0, D:0, HS:6, SL:6, C:6},
			requisitos: ['BV481'],
			color: '#4673B9',
		...
		'BV925': {
			...
			ementa: 'Apresentar os principais métodos cromatográficos usados para separar e analisar substâncias (voláteis e não voláteis) a partir de matrizes vegetais. Discutir as aplicações e restrições dos métodos espectroscópicos mais usados para a sua identificação. Analisar a aplicação de modernas técnicas cromatográficas hifenadas com espectrometria de massas no estudo de substâncias de origem vegetal em diferentes matrizes. Apresentar metodologia analítica usada em estudos metabolômicos e em biociências. Estudos de casos.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#6E46B9',
