const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG122', 'QG111', 'EM102', 'MA141', 'MA111', 'F_128', 'EM110']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM240', 'F_129', 'EM200', 'EM306', 'MA211', 'F_328', 'ME414', 'EM103']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'EM335', 'F_329', 'MC102', 'MA311', 'EM360', 'F_428']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM641', 'F_429', 'EM406', 'EM404', 'MS211', 'MA327', 'EM461', 'EM460']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM737', 'EM014', 'EM506', 'EM638', 'EM503', 'EM504', 'EM570', 'EM561']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM665', 'EM733', 'EM535', 'EM909', 'EM607', 'ET017', 'EM670']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM730', 'EM833', 'EM853', 'EM608', 'EM707', 'EM703', 'EM783', 'EM884']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM740', 'BE310', 'CE738', 'EM790', 'EM807', 'ELET08', 'EM984']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM928', 'CE304', 'EM926', 'ELET09', 'EM105']
		},
		'sem-10': {
			id: '10',
