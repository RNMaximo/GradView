const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['FM201', 'F_008', 'FM003', 'MS149']
		},
		'sem-2': {
			id: '2',
			subjects: ['EL683', 'MA141', 'MA111', 'EL285', 'FM301']
		},
		'sem-3': {
			id: '3',
			subjects: ['ME414', 'MA211', 'F_128', 'F_129']
		},
		'sem-4': {
			id: '4',
			subjects: ['EL212', 'MA311', 'F_228', 'F_229']
		},
		'sem-5': {
			id: '5',
			subjects: ['MC102', 'MA327', 'F_328', 'F_329']
		},
		'sem-6': {
			id: '6',
			subjects: ['EL511', 'ELET06', 'F_428', 'EL213', 'F_429']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'F_320', 'F_315', 'F_609', 'EL774']
		},
		'sem-8': {
			id: '8',
			subjects: ['F_502', 'F_589', 'FL701', 'ELET08', 'EL874']
		},
		'sem-9': {
			id: '9',
			subjects: ['FL801', 'F_489', 'F_901', 'ELET09', 'F_740']
		},
		'sem-10': {
			id: '10',
	...
	eletivas: {
		...
		'elet-5': {
			credits: 6,
			hasRestrictions: true,
			subjects: ['F_530', 'F_630', 'F_709', 'F_730', 'F_809', 'FL702'],
		},
	},
	...
	subjects: {
		'F_008': {
			...
			ementa: 'Introdução à ciência como forma de conhecimento. A matemática como linguagem da ciência. Grandezas, unidades e medidas. Movimentos no Universo. Energia e potência. Leis do movimento de Newton. Física térmica. Oscilações e Ondas. Ondas sonoras. Óptica. Ondas eletromagnéticas.',
			semestre: 1,
