const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['FA173', 'MA141', 'MA111', 'MC102', 'QG102', 'QG101', 'FA100']
		},
		'sem-2': {
			id: '2',
			subjects: ['FA273', 'MA211', 'ME414', 'F_128', 'F_129', 'FA270', 'BT330']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'EM306', 'FA374', 'F_328', 'FA370', 'F_329', 'FA373', 'FA379']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV323', 'EM406', 'FA470', 'FA474', 'FA481', 'FA425', 'FA473', 'FA479']
		},
		'sem-5': {
			id: '5',
			subjects: ['FA520', 'FA585', 'EM506', 'FA576', 'FA503', 'FA573', 'FA564', 'FA577', 'FA586', 'FA983']
		},
		'sem-6': {
			id: '6',
			subjects: ['FA665', 'FA670', 'FA682', 'FA622', 'FA676', 'ET016', 'FA680', 'FA679', 'FA673']
		},
		'sem-7': {
			id: '7',
			subjects: ['FA720', 'FA721', 'FA782', 'FA770', 'FA786', 'FA780', 'FA733', 'FA778', 'FA779']
		},
		'sem-8': {
			id: '8',
			subjects: ['FA870', 'FA877', 'FA878', 'FA880', 'FA876', 'FA879', 'FA874', 'FA873']
		},
		'sem-9': {
			id: '9',
			subjects: ['FA070', 'ELET09', 'FA972', 'FA984', 'FA979']
		},
		'sem-10': {
			id: '10',
	...
	subjects: {
		...
		'FA104': {
			...
			ementa: 'Conceitos de cartografia digital e projeções cartográficas; Introdução ao GNSS (Global Navigation Satellite System); Sistemas de Informações geográficas; Espacialização de dados; Geoestatística; Aplicações em agricultura.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:2, HS:4, SL:2, C:2},
			requisitos: ['FA665'],
			color: '#B04680',
			obligatory: false
		},
