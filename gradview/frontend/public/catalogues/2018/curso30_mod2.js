const catalogue = {
	...
	semesters: {
		...
		'sem-3': {
			id: '3',
			subjects: ['HG302', 'ELET03', 'HG304', 'HG301', 'HG308']
		},
		'sem-4': {
			id: '4',
			subjects: ['ELET04', 'HG401', 'HG402', 'HG404']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'EL774', 'EL213', 'HG307', 'HG303']
		},
		'sem-6': {
			id: '6',
			subjects: ['HG407', 'EL874', 'HG861', 'ELET06', 'HG403']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07']
	...
	subjects: {
		...
		'HG308': {
			...
			semestre: 1,
			vector: {T:0, P:3, L:0, O:5, D:0, HS:8, SL:0, C:8},
			requisitos: ['AA200'],
			color: '#B946B0',
			obligatory: true
		},
