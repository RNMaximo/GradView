const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL101', 'NC400', 'GL100', 'GL604']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL203', 'GL202', 'ELET02', 'GL201', 'NC100']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL300', 'GL600', 'NC301', 'GL301', 'GL302']
		},
		'sem-4': {
			id: '4',
			subjects: ['LE702', 'GL603', 'GL200', 'LE803', 'GL400', 'GL403']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL505', 'GL502', 'GL501', 'ELET05', 'GL506', 'GL504']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL900', 'GL602', 'GL601', 'ER200', 'GL607', 'GL605', 'GL606']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'PG701', 'ELET07', 'PG703', 'GL701', 'PG704', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'ELET08', 'PG809', 'GL801', 'PG801', 'PG802']
		}
	},
