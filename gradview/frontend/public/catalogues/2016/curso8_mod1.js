const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG101', 'FA100', 'QG102', 'MA111', 'MC102', 'MA141', 'FA173']
		},
		'sem-2': {
			id: '2',
			subjects: ['FA270', 'BT330', 'F_128', 'ME414', 'F_129', 'MA211', 'FA273']
		},
		'sem-3': {
			id: '3',
			subjects: ['FA373', 'FA379', 'F_328', 'FA370', 'F_329', 'FA374', 'EM306', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['FA481', 'FA479', 'FA473', 'FA425', 'CV323', 'FA470', 'EM406', 'FA474']
		},
		'sem-5': {
			id: '5',
			subjects: ['FA983', 'FA564', 'FA503', 'FA573', 'FA577', 'FA576', 'FA520', 'FA585', 'EM506', 'FA586']
		},
		'sem-6': {
			id: '6',
			subjects: ['FA680', 'ET016', 'FA622', 'FA676', 'FA673', 'FA665', 'FA679', 'FA670', 'FA682', 'FA878']
		},
		'sem-7': {
			id: '7',
			subjects: ['FA780', 'FA733', 'FA786', 'FA778', 'FA770', 'FA720', 'FA779', 'FA721', 'FA782']
		},
		'sem-8': {
			id: '8',
			subjects: ['FA874', 'FA876', 'FA873', 'FA880', 'FA879', 'FA877', 'FA870']
		},
		'sem-9': {
			id: '9',
			subjects: ['FA972', 'FA070', 'FA984', 'FA979', 'ELET09']
		},
		'sem-10': {
			id: '10',
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['AM030', 'EI001', 'EI002', 'EI003', 'EI004', 'FA001', 'FA002', 'FA006', 'FA013', 'FA016', 'FA017', 'FA018', 'FA019', 'FA020', 'FA021', 'FA024', 'FA026', 'FA028', 'FA030', 'FA031', 'FA032', 'FA033', 'FA039', 'FA041', 'FA042', 'FA043', 'FA044', 'FA048', 'FA050', 'FA051', 'FA052', 'FA054', 'FA055', 'FA056', 'FA057', 'FA058', 'FA059', 'FA060', 'FA061', 'FA062', 'FA063', 'FA064', 'FA065', 'FA066', 'FA067', 'FA068', 'FA069', 'FA073', 'FA074', 'FA075', 'FA076', 'FA080', 'FA081', 'FA082', 'FA083', 'FA084', 'FA085', 'FA086', 'FA087', 'FA088', 'FA089', 'FA090', 'FA091', 'FA092', 'FA093', 'FA094', 'FA095', 'FA096'],
		},
	},
	...
	subjects: {
		...
		'FA093': {
			...
			ementa: 'Noções de mercado de ações, a termo, de opções, futuro, de ouro, de derivativos, de opções e mercado de commodities agrícolas. Funções e estruturas. Aspectos positivos e negativos para o <i>hedger</i> e para o especulador, do ponto de vista do mercado e da política econômica do Governo.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['FA720'],
			color: '#B946B4',
