const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['BZ183', 'BC183', 'BG181', 'EL212', 'QG107']
		},
		'sem-2': {
			id: '2',
			subjects: ['BT282', 'BT283', 'BC283', 'BZ283', 'BZ281', 'EL683', 'BB281']
		},
		'sem-3': {
			id: '3',
			subjects: ['BB381', 'BT384', 'BT383', 'BL033', 'BD692', 'BZ382', 'MS380', 'BZ383']
		},
		'sem-4': {
			id: '4',
			subjects: ['BT483', 'BA480', 'BH482', 'BF483', 'BT484', 'ME414']
		},
		'sem-5': {
			id: '5',
			subjects: ['BE581', 'BI520', 'BF583', 'F_107', 'BL583']
		},
		'sem-6': {
			id: '6',
			subjects: ['EL511', 'BZ681', 'BE681', 'BZ682', 'BH620', 'BG481', 'ELET06', 'BV620', 'BL028', 'BL035']
		},
		'sem-7': {
			id: '7',
			subjects: ['EL774', 'BL682', 'GM280', 'BG520', 'BL200', 'BV720', 'FN468']
		},
		'sem-8': {
			id: '8',
			subjects: ['BP820', 'BD520', 'GM450', 'ELET08', 'EL885', 'BT885', 'BT681', 'BT880', 'BL030']
		},
		'sem-9': {
			id: '9',
			subjects: ['BD694', 'BL034', 'BH780', 'EL876', 'BM720', 'ELET09']
		},
		'sem-10': {
			id: '10',
			subjects: ['BL029', 'BD792', 'BG680', 'ELET10', 'BL031']
		}
	},
	...
	subjects: {
		'BC183': {
			...
			ementa: 'Métodos de estudo da célula. Estrutura, ultraestrutura, composição e fisiologia dos componentes celulares (Bio-membranas, núcleo, nucléolo, cromatina, cromossomos, ribossomos e síntese proteica, Retículo Endoplasmático, Complexo de Golgi, Sistema Endossômico-lisossômico, mitocôndrias cloroplastos, citoesqueleto e junções Celulares). Apresentar relatórios do que foi observado em cada aula prática.',
			semestre: 1,
		...
		'EL110': {
			...
			ementa: 'Estudo das representações culturais em circulação na sociedade, em suas articulações com os saberes produzidos pelos diferentes campos de ciências.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#B98146',
		...
		'EL210': {
			...
			ementa: 'Abordagens de temas contemporâneos direta ou indiretamente relacionados ao campo da educação, da ciência e da arte.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#4668B9',
