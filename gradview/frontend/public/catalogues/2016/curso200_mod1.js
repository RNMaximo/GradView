const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG191', 'EF091', 'LA083', 'BG091', 'TL106', 'MA091', 'GM091', 'LA091']
		},
		'sem-2': {
			id: '2',
			subjects: ['BF092', 'LA084', 'EN092', 'HH092', 'FI092', 'MA092', 'LA092']
		},
		'sem-3': {
			id: '3',
			subjects: ['GT001', 'MD163', 'ELET03', 'CS093', 'PF095', 'ME093', 'LA093', 'PF093']
		},
		'sem-4': {
			id: '4',
			subjects: ['PF094', 'PF096', 'MC001', 'EP094', 'CV043', 'LA094', 'ELET04']
		}
	},
	...
	subjects: {
		...
		'PF093': {
			...
			ementa: 'Iniciação ao pensamento crítico relativo ao conhecimento científico e senso comum. Inserção do aluno no cotidiano do processo criativo, em atividades de pesquisa laboratoriais ou artísticas. Noções sobre a pesquisa científica e suas características.',
			semestre: 1,
