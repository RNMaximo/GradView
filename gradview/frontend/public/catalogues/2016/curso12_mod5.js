const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV151', 'CV111', 'CV101', 'QG102', 'CV141', 'MC102', 'MA111', 'MA141']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'CV201', 'CV202', 'F_129', 'ME414', 'F_128', 'MA211']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV351', 'CV321', 'CV332', 'F_229', 'CV312', 'CV301', 'MS211', 'CV311']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV401', 'CV421', 'CV402', 'CV450', 'CV411', 'F_329', 'CV431', 'F_328', 'CV422']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV522', 'CV501', 'CV521', 'CV511', 'ELET05', 'CV541', 'CV531', 'CV532']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'CV621', 'CV622', 'CV612', 'CV613', 'CV633', 'CV632', 'CV641', 'CV631']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV721', 'CV713', 'CV712', 'CV714', 'CV701', 'CV722', 'CV702', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV841', 'CV823', 'CV812', 'CV813', 'CV814', 'CV821', 'CV811', 'CV832', 'ELET08', 'CV822', 'CV831']
		},
		'sem-9': {
			id: '9',
