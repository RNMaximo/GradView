const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV101', 'CV151', 'QG102', 'CV141', 'MA141', 'MA111', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'CV201', 'CV202', 'ME414', 'MA211', 'F_129', 'F_128']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV351', 'CV312', 'CV321', 'CV332', 'CV311', 'MS211', 'CV301', 'F_229']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV450', 'CV411', 'CV402', 'CV401', 'CV421', 'CV431', 'F_328', 'F_329', 'CV422']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV522', 'CV521', 'CV541', 'CV531', 'ELET05', 'CV532']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV622', 'CV621', 'CV633', 'CV631', 'CV641', 'CV632', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV701', 'CV713', 'CV714', 'CV721', 'CV722', 'CV702', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV813', 'CV831', 'CV814', 'CV823', 'CV821', 'CV811', 'CV822', 'CV832', 'CV812', 'CV841', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV916', 'CV912', 'CV911', 'CV954', 'ELET09']
		},
		'sem-10': {
			id: '10',
