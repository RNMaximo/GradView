const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG100', 'EM102', 'EM330', 'MA141', 'MA111', 'EM110', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM240', 'EM200', 'EM335', 'MA211', 'F_328', 'F_129', 'ELET02']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM440', 'MC102', 'EM306', 'MA311', 'F_428', 'F_329', 'EM360']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM103', 'EM406', 'MS211', 'EM404', 'F_429', 'EM461', 'EM460', 'MA327']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM506', 'EM503', 'EM504', 'EM535', 'ME414', 'EM570', 'EM561']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM833', 'EM641', 'EM638', 'EM607', 'ET016', 'EM670', 'EM733', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM740', 'EM731', 'EM730', 'EM707', 'EM703', 'EM884', 'EM976', 'EM783']
		},
		'sem-8': {
			id: '8',
			subjects: ['CE738', 'EM977', 'EM608', 'EM853', 'EM807', 'EM973', 'EM984', 'EM886', 'EM972', 'BE310']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM990', 'EM914', 'EM974', 'EM790', 'EM983', 'EM873', 'EM975', 'EM044', 'CE304']
		},
		'sem-10': {
			id: '10',
			subjects: ['EM919', 'EM916', 'EM048']
		}
	},
	...
	subjects: {
		...
		'EM044': {
			code: 'EM044',
			name: 'Fontes de Energia',
			ementa: 'Recursos minerais energéticos e fontes renováveis de energia. Histórico da produção e consumo de energia no Brasil e no mundo. Influência dos fatores tecnológicos, econômicos, políticos, sociais e ecológicos nos seguintes sistemas energéticos: petróleo, carvão mineral, gás natural, energia nuclear, energia hidráulica, biomassa, energia solar, energia eólica e outros. Avaliação crítica do suprimento de energia no Brasil.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['EM884'],
			color: '#804F8C',
		...
		'EM048': {
			code: 'EM048',
			name: 'Gerência Energética em Processos Industriais',
			ementa: 'Uso Racional de Energia: Conceitos e Princípios da Conservação e da Substituição. Análise de Processos Industriais Energo-Intensivos e Caracterização do Uso de Energia. Instrumentos de Análise, Diagnóstico e Auditoria. Princípios da Gestão do Uso de Energia. Otimização Energética em Sistemas Industriais. Aspectos Ambientais da Gestão do Uso de Energia: Subprodutos, Resíduos, Efluentes e Reciclagens.',
			semestre: 1,
			vector: {T:3, P:1, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['EM670', 'EM884'],
			color: '#804F8C',
			obligatory: true
		},
		'EM916': {
