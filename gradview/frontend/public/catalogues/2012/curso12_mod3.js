const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV151', 'CV101', 'MC102', 'MA111', 'QG102', 'CV141', 'MA141']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'MA211', 'CV201', 'ME203', 'F_129', 'CV202', 'F_128']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV312', 'CV311', 'CV321', 'MS211', 'CV351', 'CV332', 'CV301', 'F_229']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV411', 'CV422', 'CV431', 'CV402', 'CV401', 'F_329', 'CV450', 'F_328', 'CV421']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV521', 'CV511', 'CV501', 'CV522', 'CV531', 'CV532', 'CV541', 'ELET05']
		},
		'sem-6': {
			id: '6',
		...
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV714', 'CV721', 'CV701', 'CV702', 'CV741', 'CV722']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV841', 'CV831', 'CV814', 'CV813', 'CV823', 'CV811', 'CV832', 'CV812', 'CV821', 'CV822', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'CV906', 'CV068', 'CV954']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV951', 'CV902', 'CV903', 'CV955', 'CV900']
		}
	},
