const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GF301', 'GN108', 'GN101', 'GN110', 'GN106']
		},
		'sem-2': {
			id: '2',
			subjects: ['GF401', 'GN301', 'GN107', 'GN208', 'GN105']
		},
		'sem-3': {
			id: '3',
			subjects: ['ME173', 'BD101', 'EL683', 'GF303', 'LA122']
		},
		'sem-4': {
			id: '4',
			subjects: ['GF410', 'GN207', 'GF402', 'GF129', 'GF503', 'LA242']
		},
		'sem-5': {
			id: '5',
			subjects: ['GF509', 'GF302', 'GF506', 'GF508', 'EL511']
		},
		'sem-6': {
			id: '6',
			subjects: ['EL212', 'GF601', 'GF507', 'GE801', 'GF801']
		},
		'sem-7': {
			id: '7',
			subjects: ['EL774', 'ELET07', 'GF502', 'GF604', 'GF501']
		},
		'sem-8': {
			id: '8',
			subjects: ['EL874', 'GF405', 'GF605', 'GN304', 'BT201']
		},
		'sem-9': {
			id: '9',
			subjects: ['GF603', 'GF602', 'ELET09', 'GF806', 'GF703']
		},
		'sem-10': {
			id: '10',
			subjects: ['GF805', 'ELET10', 'GF406', 'GF901']
		}
	},
	...
	eletivas: {
		...
		'elet-3': {
			credits: 4,
			hasRestrictions: true,
			subjects: ['GE403', 'GE911', 'GE912', 'GE913', 'GE914', 'GE915', 'GE916', 'GF001', 'GF002', 'GF003', 'GF100', 'GF102', 'GF105', 'GF106', 'GF107', 'GF111', 'GF112', 'GF115', 'GF120', 'GF121', 'GF123', 'GF124', 'GF125', 'GF126', 'GF130', 'GF131', 'GF132', 'GF133', 'GF134', 'GF505'],
		},
	},
	...
	subjects: {
		...
		'BT201': {
			code: 'BT201',
			name: 'Biogeografia',
			ementa: 'Biosfera, fluxos de energia e ciclos biogeoquímicos. Análise do homem com o modificador da paisagem vegetal. Biogeografia e sistemas (ecossistema, geossistema, agroecossistema e sistemas urbanos). Fitogeografia e Zoogeografia do Brasil. Biodiversidade. Biomas do mundo.',
			semestre: 1,
			vector: {T:3, P:0, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: '',
			color: '#466EB9',
