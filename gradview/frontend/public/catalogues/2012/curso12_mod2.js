const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV101', 'CV151', 'CV141', 'QG102', 'MC102', 'MA141', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'CV201', 'CV202', 'MA211', 'ME203', 'F_128', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV312', 'CV321', 'CV332', 'CV351', 'CV311', 'MS211', 'F_229', 'CV301']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV411', 'CV421', 'CV401', 'CV422', 'CV431', 'F_328', 'CV450', 'F_329']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV522', 'CV511', 'CV501', 'CV521', 'CV531', 'CV541', 'ELET05', 'CV532']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV622', 'CV633', 'CV621', 'CV632', 'CV641', 'CV631', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV714', 'CV722', 'CV721', 'CV702', 'CV701', 'CV741', 'CV713']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV812', 'CV821', 'CV814', 'CV823', 'CV811', 'CV822', 'CV832', 'CV831', 'CV841', 'ELET08', 'CV813']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV911', 'CV910', 'ELET09', 'CV916', 'CV954', 'CV912', 'CV913']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV951', 'ELET10', 'CV955']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['CV010', 'CV011', 'CV012', 'CV013', 'CV014', 'CV015', 'CV016', 'CV017', 'CV018', 'CV019', 'CV064', 'CV065', 'CV066', 'CV067', 'CV070', 'CV071', 'CV072', 'CV073', 'CV074', 'CV075', 'CV091', 'CV914', 'CV915', 'CV917', 'CV918', 'CV919', 'CV952', 'CV953'],
		},
		'elet-2': {
			credits: 7,
	...
	subjects: {
		...
		'CV641': {
			...
			semestre: 1,
			vector: {T:2, P:1, L:0, O:1, D:1, HS:5, SL:3, C:4},
		...
		'CV713': {
			...
			ementa: 'Coeficientes de ponderação de cargas. Traves em treliça. Estruturas para coberturas em duas águas. Cargas para projeto de edifícios. Efeito de vento nas edificações com cobertura em duas águas. Determinação de esforços em estruturas treliçadas das coberturas. Dimensionamento à tração e compressão de barras com perfil laminado. Ligações parafusadas e soldadas sob tração e compressão. Projeto de ligações nas coberturas em duas águas.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:1, D:0, HS:4, SL:3, C:4},
			requisitos: ['CV511'],
			color: '#A37E4C',
		...
		'CV813': {
			...
			ementa: 'Dimensionamento à compressão de peças em perfis dobrados a frio. Dimensionamento à flexão de peças laminadas e em perfis dobrados a frio. Dimensionamento à flexo-compressão de peças laminadas e em perfis dobrados a frio. Determinação de esforços e dimensionamento de bases de pilares de edifícios metálicos. Ligações soldadas e parafusadas sob flexão e flexo-compressão.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:1, D:0, HS:4, SL:3, C:4},
			requisitos: ['*CV713'],
			color: '#A37E4C',
		...
		'CV912': {
			code: 'CV912',
			name: 'Estruturas Metálicas Compostas por Chapas Dobradas',
			ementa: 'Introdução. Estabilidade de elementos comprimidos. Peças comprimidas axialmente. Vigas fletidas. Ligações.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['CV713'],
			color: '#A37E4C',
