const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG101', 'QG102', 'MA111', 'FA173', 'MA141', 'MC102', 'FA100']
		},
		'sem-2': {
			id: '2',
			subjects: ['FA270', 'F_129', 'ME414', 'FA273', 'MA211', 'F_128', 'BT330']
		},
		'sem-3': {
			id: '3',
			subjects: ['FA373', 'MA311', 'F_329', 'F_328', 'EM306', 'FA374', 'FA379', 'FA370']
		},
		'sem-4': {
			id: '4',
			subjects: ['FA474', 'FA481', 'FA425', 'CV323', 'FA470', 'EM406', 'FA479', 'FA473']
		},
		'sem-5': {
			id: '5',
			subjects: ['FA564', 'FA503', 'FA573', 'FA577', 'FA576', 'FA585', 'EM506', 'FA520', 'FA586']
		},
		'sem-6': {
			id: '6',
			subjects: ['FA665', 'FA680', 'FA622', 'ET016', 'FA679', 'FA670', 'FA682', 'FA673', 'FA676']
		},
		'sem-7': {
			id: '7',
			subjects: ['FA733', 'FA721', 'FA786', 'FA770', 'FA782', 'FA779', 'FA780', 'FA720', 'FA778']
		},
		'sem-8': {
			id: '8',
			subjects: ['FA874', 'FA877', 'FA876', 'FA880', 'FA879', 'FA878', 'FA870', 'FA873']
		},
		'sem-9': {
			id: '9',
			subjects: ['FA983', 'FA972', 'ELET09', 'FA979', 'FA070', 'FA978']
		},
		'sem-10': {
			id: '10',
