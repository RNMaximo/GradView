const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MA111', 'MA141', 'MC102', 'QG101', 'TA109', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['QF331', 'MA211', 'QA213', 'QO427', 'TA221', 'F_228']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA331', 'F_328', 'TA332', 'BM320', 'TA322', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['ME414', 'MS211', 'ET016', 'TA411', 'TA421', 'CE138', 'TA431']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA541', 'TA513', 'TA514', 'TA516', 'TA534', 'TA521', 'TA542']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA610', 'TA619', 'TA615', 'TA611', 'TA641', 'TA622', 'TA620', 'TA631']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA716', 'TA017', 'TA737', 'TA726', 'TA824', 'TA731', 'TA722', 'TA623', 'TA734']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA836', 'TA736', 'TA725', 'TA729', 'TA826', 'TA920', 'TA831', 'TA832', 'TA030']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA741', 'TA912', 'TA927', 'TA932', 'TA035']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA021', 'TA046', 'TA009', 'TA909']
		}
	},
