const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC400', 'GL101', 'GL100', 'PG100', 'NC103']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'PG201', 'GL201', 'GL203', 'PG200']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'GL202', 'GL301', 'PG300', 'PG301']
		},
		'sem-4': {
			id: '4',
			subjects: ['ER201', 'GL603', 'GL400', 'PG400', 'ER401', 'PG800']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG502', 'GL502', 'PG500', 'PG704', 'PG501']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL608', 'PG701', 'PG600', 'PG801', 'GL900', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL601', 'GL701', 'ELET07', 'PG710', 'GL700', 'PG709']
		},
		'sem-8': {
			id: '8',
