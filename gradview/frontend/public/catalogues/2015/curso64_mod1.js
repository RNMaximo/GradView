const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CS104', 'CS103', 'CS102', 'CS100', 'CS105', 'MC001', 'CS106']
		},
		'sem-2': {
			id: '2',
			subjects: ['CS200', 'CS204', 'CS203', 'CS201', 'CS205', 'CS202']
		},
		'sem-3': {
			id: '3',
			subjects: ['CS301', 'CS300', 'CS306', 'CS303', 'CS039', 'CS305', 'CS304', 'CS302']
		},
		'sem-4': {
			id: '4',
			subjects: ['CS405', 'CS040', 'CS402', 'CS404', 'CS401', 'CS400', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'CS601', 'CS500', 'CS503']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06']
	...
	eletivas: {
		...
		'elet-2': {
			credits: 28,
			hasRestrictions: true,
			subjects: ['AR130', 'CS007', 'CS009', 'CS011', 'CS014', 'CS015', 'CS017', 'CS018', 'CS020', 'CS025', 'CS026', 'CS027', 'CS028', 'CS029', 'CS030', 'CS031', 'CS032', 'CS033', 'CS034', 'CS035', 'CS036', 'CS037', 'CS038', 'CS043', 'CS049', 'CS050', 'CS052', 'CS053', 'CS055', 'CS504', 'CS505', 'CS506', 'CS507', 'CS800', 'CS801'],
		},
		'elet-3': {
			credits: 12,
