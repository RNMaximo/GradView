const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC400', 'GL100', 'GL101', 'NC103', 'PG100']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'GL201', 'PG201', 'GL203', 'PG200']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'GL301', 'GL202', 'PG300', 'PG301']
		},
		'sem-4': {
			id: '4',
			subjects: ['ER201', 'GL400', 'ER401', 'GL603', 'PG400', 'PG800']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG500', 'PG704', 'GL502', 'PG502', 'PG501']
		},
		'sem-6': {
			id: '6',
			subjects: ['PG600', 'GL608', 'PG801', 'PG701', 'GL900', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL601', 'GL700', 'GL701', 'PG710', 'ELET07', 'PG709']
		},
		'sem-8': {
			id: '8',
