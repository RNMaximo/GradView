const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC102', 'QG102', 'MA141', 'MA111', 'QG101', 'FA100', 'FA173']
		},
		'sem-2': {
			id: '2',
		...
		'sem-3': {
			id: '3',
			subjects: ['FA373', 'FA374', 'F_328', 'EM306', 'F_329', 'FA370', 'FA379', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['FA481', 'CV323', 'FA470', 'FA473', 'FA425', 'FA479', 'EM406', 'FA474']
		},
		'sem-5': {
			id: '5',
			subjects: ['FA564', 'FA983', 'FA520', 'FA503', 'FA586', 'FA573', 'FA577', 'FA576', 'FA585', 'EM506']
		},
		'sem-6': {
			id: '6',
			subjects: ['FA680', 'FA665', 'FA622', 'FA676', 'ET016', 'FA673', 'FA679', 'FA682', 'FA670']
		},
		'sem-7': {
			id: '7',
			subjects: ['FA720', 'FA780', 'FA786', 'FA778', 'FA733', 'FA779', 'FA782', 'FA770', 'FA721']
		},
		'sem-8': {
			id: '8',
			subjects: ['FA877', 'FA876', 'FA878', 'FA874', 'FA873', 'FA880', 'FA879', 'FA870']
		},
		'sem-9': {
			id: '9',
			subjects: ['FA972', 'ELET09', 'FA070', 'FA984', 'FA979']
		},
		'sem-10': {
			id: '10',
	...
	subjects: {
		...
		'FA985': {
			...
			ementa: 'Desenvolvimento do projeto a partir do anteprojeto definido em FA984 Introdução ao Trabalho de Conclusão de Curso. Elaboração da Monografia. Defesa da monografia.',
			semestre: 1,
			vector: {T:0, P:1, L:0, O:1, D:0, HS:2, SL:1, C:2},
			requisitos: ['FA984'],
			color: '#60B946',
