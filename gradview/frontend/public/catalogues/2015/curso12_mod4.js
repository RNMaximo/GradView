const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV101', 'CV151', 'CV111', 'MC102', 'CV141', 'QG102', 'MA111', 'MA141']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV201', 'GM420', 'F_128', 'F_129', 'CV202', 'MA211', 'ME203']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV321', 'CV312', 'F_229', 'CV332', 'CV301', 'CV311', 'MS211', 'CV351']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV411', 'CV450', 'CV421', 'F_329', 'CV422', 'CV431', 'F_328', 'CV401']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV522', 'CV521', 'CV532', 'CV531', 'CV541', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV621', 'CV622', 'CV632', 'CV631', 'CV641', 'CV633', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV714', 'CV721', 'CV702', 'CV722', 'CV741', 'CV701']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV812', 'CV814', 'CV813', 'CV821', 'CV823', 'CV832', 'CV811', 'CV822', 'CV841', 'ELET08', 'CV831']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'CV951', 'CV941', 'CV942', 'CV945']
		},
		'sem-10': {
			id: '10',
