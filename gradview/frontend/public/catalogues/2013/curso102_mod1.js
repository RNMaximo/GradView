const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['LE100', 'LE101', 'LE106', 'LE103', 'NC103', 'LE105']
		},
		'sem-2': {
			id: '2',
			subjects: ['LE200', 'LE201', 'LE303', 'LE203', 'LE202', 'NC202', 'LE204', 'LE205', 'ER200']
		},
		'sem-3': {
			id: '3',
			subjects: ['LE301', 'GL301', 'LE400', 'LE300', 'LE302', 'NC301']
		},
		'sem-4': {
			id: '4',
			subjects: ['LE401', 'LE406', 'LE402', 'LE403', 'GL200', 'LE408', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL604', 'ER500', 'LE500', 'LE503', 'NC400', 'LE504', 'LE501']
		},
		'sem-6': {
			id: '6',
			subjects: ['LE600', 'ELET06', 'LE012', 'LE608', 'LE602', 'LE607', 'ER600', 'LE704']
		},
		'sem-7': {
			id: '7',
			subjects: ['ER700', 'ER701', 'ELET07', 'LE700', 'LE902', 'LE703', 'LE701']
		},
		'sem-8': {
			id: '8',
			subjects: ['LE901', 'ELET08', 'LE900', 'LE801', 'ER808', 'GL601']
		},
		'sem-9': {
			id: '9',
			subjects: ['ER902', 'ER900', 'ELET09', 'ER901']
		},
		'sem-10': {
			id: '10',
	...
	eletivas: {
		...
		'elet-2': {
			...
			subjects: ['AG---', 'CG---', 'ER801', 'GL---', 'LE702', 'MG---', 'PG---'],
		},
		'elet-3': {
			credits: 8,
			hasRestrictions: true,
