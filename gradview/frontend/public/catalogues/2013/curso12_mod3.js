const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'CV101', 'CV151', 'MA141', 'MC102', 'MA111', 'QG102', 'CV141']
		},
		'sem-2': {
			id: '2',
			subjects: ['MA211', 'GM420', 'ME203', 'CV201', 'CV202', 'F_128', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV312', 'CV311', 'CV321', 'CV351', 'MS211', 'CV332', 'F_229', 'CV301']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV431', 'CV411', 'CV422', 'CV401', 'CV421', 'CV402', 'F_328', 'CV450', 'F_329']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'CV511', 'CV521', 'CV522', 'CV501', 'CV531', 'CV532', 'CV541']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV621', 'CV612', 'CV613', 'CV622', 'CV633', 'CV632', 'CV631', 'CV641', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV721', 'CV701', 'CV702', 'CV714', 'CV741', 'CV722']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'CV821', 'CV813', 'CV823', 'CV814', 'CV841', 'CV832', 'CV811', 'CV822', 'CV812', 'CV831']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'CV068', 'CV906', 'CV954']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV951', 'CV903', 'CV900', 'CV902', 'CV955']
		}
	},
