const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['ES101', 'F_128', 'MA111', 'MA141', 'QG111', 'QG122']
		},
		'sem-2': {
			id: '2',
		...
		'sem-6': {
			id: '6',
			subjects: ['EA611', 'EE534', 'ES235', 'ES570', 'ES572', 'ES601']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM406', 'EM607', 'ES365', 'ES575', 'ES672', 'MC732']
		},
		'sem-8': {
			id: '8',
		...
		'sem-10': {
			id: '10',
			subjects: ['ES070', 'ES664', 'ES690', 'ES728', 'ES926', 'ELET10']
		},
		'sem-11': {
			id: '11',
			subjects: ['BE310', 'ES828', 'ES925', 'ES951', 'ELET11']
		},
		'sem-12': {
			id: '12',
	...
	subjects: {
		...
		'ES333': {
			...
			ementa: 'Normas de ensaios de materiais. Ensaios mecânicos. Ensaios não-destrutivos. Análise metalográfica. Caracterização de materiais de grau eletrônico.',
			semestre: 1,
		...
		'EG---': {
			...
			ementa: 'Esta disciplina representa qualquer disciplina oferecida pela Unicamp com codigo EG---, onde o - indica um caracter ou numero.',
			semestre: 1,
			vector: {T:0, P:0, L:0, O:0, D:0, HS:0, SL:0, C:1},
			requisitos: '',
			color: '#7B40D9',
