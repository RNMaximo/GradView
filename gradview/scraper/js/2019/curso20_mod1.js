const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EP107', 'EP110', 'EP130', 'EP140', 'EP142', 'EP570']
		},
		'sem-2': {
			id: '2',
			subjects: ['EP128', 'EP210', 'EP230', 'EP319', 'EP340', 'EP347']
		},
		'sem-3': {
			id: '3',
			subjects: ['EP129', 'EP152', 'EP165', 'EP330', 'EP412']
		},
		'sem-4': {
			id: '4',
			subjects: ['EP153', 'EP158', 'EP164', 'EP226', 'EP372', 'EP445', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['EP376', 'EP471', 'EP472', 'EP473', 'EP474', 'EP910']
		},
		'sem-6': {
			id: '6',
			subjects: ['EP144', 'EP377', 'EP790', 'EP911', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['EP139', 'EP146', 'EP147', 'EP162', 'EP348', 'EP808', 'EP912', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['EP529', 'EP809', 'EP879', 'EP887', 'EP913', 'EP914', 'EP915', 'EP916']
		}
	},
	...
	subjects: {
		...
		'EP570': {
			code: 'EP570',
			name: 'Estudo e Produção Acadêmica',
		...
		'EP330': {
			...
			ementa: 'Estudo de filósofos e/ou correntes filosóficas contemporâneas que mais significativamente contribuíram para a reflexão sobre problemas pedagógicos ou que forneceram fundamentos filosóficos da educação ocidental, iniciando com o iluminismo kantiano incluindo as concepções positivista',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: '',
			color: '#7640D9',
		...
		'EP226': {
			...
			ementa: 'Análise de questões relativas ao contexto educativo, pelo olhar da psicologia, com base em pesquisas e relatos de práticas.',
			semestre: 1,
			vector: {T:3, P:2, L:0, O:0, D:0, HS:5, SL:4, C:5},
			requisitos: '',
			color: '#40D99A',
			obligatory: true
		},
		...
		'EP376': {
			code: 'EP376',
			name: 'Práticas Ensino Estágio Supervisionado nos Anos Iniciais Ensino Fundamental',
		...
		'EP144': {
			...
			ementa: 'A disciplina visa inserir os estudantes de Pedagogia no exercício da pesquisa em Ciências Sociais e Educação, focalizando aspectos relacionados às dimensões teórico-metodológicas, às etapas básicas da pesquisa e a elaboração do projeto de pesquisa, bem como o delineamento dos procedimentos para a descrição, análise e interpretação da realidade social e educacional.',
			semestre: 1,
			vector: {T:4, P:2, L:0, O:0, D:0, HS:6, SL:4, C:6},
			requisitos: '',
			color: '#40BED9',
		...
		'EP377': {
			...
			semestre: 1,
			vector: {T:2, P:4, L:0, O:2, D:0, HS:8, SL:4, C:8},
			requisitos: '',
			color: '#D040D9',
			obligatory: true
		},
		...
		'EP139': {
			...
			ementa: 'Esta disciplina discute o conceito de infância a partir das contribuições das Ciências Sociais. Traça um breve histórico da Educação infantil e do desenvolvimento dos Estudos da Infância no Brasil. A partir da articulação com os documentos do MEC para a Educação Infantil e da produção atual de pesquisadoras/es da infância e da educação infantil, propõe-se o estudo da(s) pedagogia(s) da educação infantil tendo como principais eixos de discussão: o currículo, a ação docente, o papel das culturas infantis, da arte e das múltiplas linguagens nos processos de educação e socialização de bebês e crianças e o lugar da diferença (sobretudo de gênero e raça/etnia) em creches e pré-escolas.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: '',
			color: '#D98840',
		...
		'EP915': {
			code: 'EP915',
			name: 'Histórias e Culturas Afro-brasileiras e Africanas',
			ementa: 'Ideologia da democracia racial, relações racializadas no Brasil e o papel da escola – aspectos históricos e contemporâneos; educação das relações étnico-raciais; ações afirmativas e perspectivas (políticas, institucionais e relacionais) de enfrentamento ao racismo; africanidades em práticas culturais e educativas.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:2, C:3},
			requisitos: '',
			color: '#40D964',
		...
		'EP916': {
			code: 'EP916',
			name: 'Histórias e Culturas de Povos Indígenas Brasileiros',
			ementa: 'Estudos sobre as dinâmicas culturais dos povos indígenas no Brasil. Processos históricos e sociais de contato com as sociedades não- indígenas. Saberes, práticas culturais e educativas indígenas.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:2, C:3},
			requisitos: '',
			color: '#BE40D9',
