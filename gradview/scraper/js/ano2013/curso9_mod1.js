const catalogue = {
	...
	semesters: {
		...
		'sem-9': {
			id: '9',
			subjects: ['EQ902', 'EQ922', 'EQ950', 'ELET4']
		},
		'sem-10': {
			id: '10',
			subjects: ['EQ004', 'EQ050', 'ELET8']
		}
	},
	...
	subjects: {
		...
		'EQ531': {
			...
			semestre: 1,
			vector: {T:3, P:1, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['*QI242', '*QI244', '*QO323/*QI242', '*QI244', '*QO427/*QI242', '*QI244', '*QO321', '*QO421/*QG108', '*QI145', '*QI245', '*QO321', '*QO421']
		},
		'F_313': {
			code: 'F_313',
			name: 'Mecânica Geral',
