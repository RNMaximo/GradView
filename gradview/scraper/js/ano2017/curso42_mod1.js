const catalogue = {
	...
	semesters: {
		...
		'sem-6': {
			id: '6',
			subjects: ['MC504', 'MC626', 'MC658', 'MS211', 'ELET4']
		},
		'sem-7': {
			id: '7',
			subjects: ['MC732', 'MC832', 'ELET20']
		},
		'sem-8': {
			id: '8',
			subjects: ['CE839', 'MC714', 'MC833', 'MC921', 'ELET4']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE738', 'ELET20']
		},
		'sem-10': {
			id: '10',
			subjects: ['CE304', 'ELET26']
		}
	},
	...
	subjects: {
		...
		'ELET26': {
			...
			ementa: '[]',
			semestre: 1,
			vector: {T:26, P:0, L:0, O:0, D:0, HS:0, SL:0, C:26},
			requisitos: ''
		}
	}
};
