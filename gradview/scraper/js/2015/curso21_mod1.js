const catalogue = {
	...
	subjects: {
		...
		'EN590': {
			...
			ementa: 'Fundamentos teóricos para a prática do trabalho gerencial e assistencial em enfermagem: teorias administrativas e modelos de gestão; processo de trabalho; tomada de decisão e resolução de problemas; modelo de organização do atendimento ao paciente; dimensionamento e distribuição de pessoal; recrutamento e seleção de pessoal; avaliação de desempenho; educação permanente e segurança na saúde.',
			semestre: 1,
			vector: {T:3, P:0, L:0, O:0, D:0, HS:3, SL:3, C:3},
		...
		'EN690': {
			...
			ementa: 'Ensino teórico-prático de aspectos fundamentais para a organização, direção e controle do gerenciamento de enfermagem na atenção hospitalar: planejamento estratégico; gestão de recursos materiais; gestão de custo; serviços de apoio; mudança e negociação; supervisão, liderança e trabalho em equipe; auditoria de processos assistenciais; gerenciamento de risco e segurança na saúde.',
			semestre: 1,
