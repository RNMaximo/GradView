const catalogue = {
	...
	semesters: {
		...
		'sem-3': {
			id: '3',
			subjects: ['BG380', 'BI381', 'BM382', 'BT480', 'BV381', 'BZ380', 'ELET4']
		},
		'sem-4': {
			id: '4',
		...
		'sem-5': {
			id: '5',
			subjects: ['BF582', 'BP480', 'ME480', 'ELET20']
		},
		'sem-6': {
			id: '6',
			subjects: ['BF682', 'GM450', 'ELET20']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET17']
	...
	subjects: {
		...
		'ELET21': {
			...
			ementa: '[]',
			semestre: 1,
			vector: {T:21, P:0, L:0, O:0, D:0, HS:0, SL:0, C:21},
			requisitos: ''
		}
	}
};
