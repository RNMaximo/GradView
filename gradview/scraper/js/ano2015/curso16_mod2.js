const catalogue = {
	...
	semesters: {
		...
		'sem-2': {
			id: '2',
			subjects: ['HZ248', 'HZ258', 'HZ260', 'ELET4']
		},
		'sem-3': {
			id: '3',
			subjects: ['HZ345', 'HZ358', 'HZ360', 'ELET4']
		},
		'sem-4': {
			id: '4',
			subjects: ['HZ431', 'HZ447', 'ELET06']
		},
		'sem-5': {
			id: '5',
			subjects: ['HZ546', 'ELET18']
		},
		'sem-6': {
			id: '6',
	...
	subjects: {
		...
		'ELET06': {
			...
			ementa: '[]',
			semestre: 1,
			vector: {T:06, P:0, L:0, O:0, D:0, HS:0, SL:0, C:06},
			requisitos: ''
		},
		'HZ546': {
			code: 'HZ546',
