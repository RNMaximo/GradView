const catalogue = {
	...
	semesters: {
		...
		'sem-6': {
			id: '6',
			subjects: ['EE534', 'MC426', 'MC458', 'MC536', 'MC732', 'MC832']
		},
		'sem-7': {
			id: '7',
		...
		'sem-8': {
			id: '8',
			subjects: ['CE838', 'CE839', 'EA044', 'MC658', 'MC855', 'MC910', 'ELET4']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE738', 'MC911', 'ELET19']
		},
		'sem-10': {
			id: '10',
	...
	subjects: {
		...
		'ELET19': {
			...
			ementa: '[]',
			semestre: 1,
			vector: {T:19, P:0, L:0, O:0, D:0, HS:0, SL:0, C:19},
			requisitos: ''
		},
		'MC030': {
			code: 'MC030',
