const catalogue = {
	...
	semesters: {
		...
		'sem-7': {
			id: '7',
			subjects: ['ST722', 'ST723', 'ST729', 'ELET12']
		}
	},
	...
	subjects: {
		...
		'ST215': {
			...
			semestre: 1,
			vector: {T:2, P:0, L:2, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['*EB101', '*ST362/*ST109', '*ST362/*EB101', '*EB102']
		},
		'ST304': {
			code: 'ST304',
		...
		'ST309': {
			...
			semestre: 1,
			vector: {T:2, P:2, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['*ST209', '*ST215', '*TT101/*EB101', '*ST215']
		},
		'ST401': {
			code: 'ST401',
			name: 'Topografia II',
		...
		'ST527': {
			...
			semestre: 1,
			vector: {T:2, P:2, L:0, O:2, D:0, HS:6, SL:4, C:6},
			requisitos: ['*ST420', '*ST423/*EB603', '*ST423']
		},
		'ST529': {
			code: 'ST529',
		...
		'ST628': {
			...
			semestre: 1,
			vector: {T:2, P:2, L:0, O:2, D:0, HS:6, SL:4, C:6},
			requisitos: ['*ST526', '*ST527/*EB944', '*ST526']
		},
		'ST728': {
			code: 'ST728',
