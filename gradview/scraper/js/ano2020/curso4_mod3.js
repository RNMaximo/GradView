const catalogue = {
	...
	semesters: {
		...
		'sem-5': {
			id: '5',
			subjects: ['BS580', 'F_502', 'F_520', 'F_589', 'ELET4']
		},
		'sem-6': {
			id: '6',
			subjects: ['BS681', 'F_320', 'F_489', 'F_550', 'F_689']
		},
		'sem-7': {
			id: '7',
			subjects: ['F_551', 'F_604', 'F_751', 'F_758', 'ELET4']
		},
		'sem-8': {
			id: '8',
			subjects: ['F_854', 'F_857', 'F_887', 'MD760', 'ELET4']
		},
		'sem-9': {
			id: '9',
			subjects: ['MD947']
	...
	subjects: {
		...
		'ELET24': {
			...
			ementa: '[]',
			semestre: 1,
			vector: {T:24, P:0, L:0, O:0, D:0, HS:0, SL:0, C:24},
			requisitos: ''
		}
	}
};
