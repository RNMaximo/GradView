const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EP107', 'EP110', 'EP130', 'EP140', 'EP142', 'EP315']
		},
		'sem-2': {
			id: '2',
			subjects: ['EP128', 'EP210', 'EP230', 'EP316', 'EP340', 'EP347']
		},
		'sem-3': {
			id: '3',
			subjects: ['EP129', 'EP152', 'EP165', 'EP317', 'EP330', 'EP412']
		},
		'sem-4': {
			id: '4',
			subjects: ['EP153', 'EP158', 'EP164', 'EP226', 'EP445', 'EP566', 'ELET04']
		},
		'sem-5': {
			id: '5',
		...
		'sem-6': {
			id: '6',
			subjects: ['EP144', 'EP372', 'EP377', 'EP567', 'EP790', 'EP911', 'ELET06']
		},
		'sem-7': {
			id: '7',
		...
		'sem-8': {
			id: '8',
			subjects: ['EP529', 'EP568', 'EP809', 'EP887', 'EP913', 'EP914', 'ELET08']
		}
	},
	...
	subjects: {
		...
		'EP129': {
			code: 'EP129',
			name: 'Psicologia II',
			ementa: 'Contribuições das perspectivas teóricas construtivistas e histórico-cultural para o estudo do processo de ensino, aprendizagem e desenvolvimento e suas implicações para o contexto educativo.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: '',
			color: '#4064D9',
