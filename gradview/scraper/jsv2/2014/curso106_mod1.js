const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GL101', 'GL604', 'NC400', 'GL100', 'NC103']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL202', 'GL203', 'NC100', 'GL201', 'ELET02']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL600', 'GL300', 'GL302', 'GL301', 'NC301']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL603', 'LE702', 'LE803', 'GL400', 'GL200', 'GL403']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL502', 'ELET05', 'GL506', 'GL505', 'GL501', 'GL504']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL605', 'GL601', 'ER200', 'GL607', 'GL602', 'GL606', 'GL900']
		},
		'sem-7': {
			id: '7',
			subjects: ['PG701', 'GL700', 'PG703', 'PG704', 'GL701', 'PG709', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'ELET08', 'PG809', 'PG801', 'GL801', 'PG802']
		}
	},
