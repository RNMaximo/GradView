const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL100', 'PG100', 'GL101', 'NC400']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'GL201', 'PG200', 'PG201', 'GL203']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'GL301', 'PG301', 'GL202', 'PG300']
		},
		'sem-4': {
			id: '4',
			subjects: ['ER401', 'GL400', 'PG400', 'GL603', 'PG800', 'ER201']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG704', 'PG502', 'PG501', 'GL502', 'PG500']
		},
		'sem-6': {
			id: '6',
			subjects: ['PG801', 'GL900', 'NC100', 'PG701', 'GL608', 'PG600']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'GL701', 'GL700', 'GL601', 'PG709', 'PG710']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'GL801', 'GL800', 'PG810']
		}
	},
