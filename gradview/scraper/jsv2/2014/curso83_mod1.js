const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['ST103', 'ST114', 'TT101', 'ST109', 'ST362']
		},
		'sem-2': {
			id: '2',
			subjects: ['ST213', 'ST211', 'ST216', 'ST209', 'ST215']
		},
		'sem-3': {
			id: '3',
			subjects: ['ST301', 'ST303', 'ST210', 'ST309', 'ST304']
		},
		'sem-4': {
			id: '4',
			subjects: ['ST401', 'ST403', 'ST410', 'ST423', 'ST420']
		},
		'sem-5': {
			id: '5',
			subjects: ['ST726', 'ST525', 'ST515', 'ST529', 'ST527', 'ST526']
		},
		'sem-6': {
			id: '6',
			subjects: ['ST626', 'ST306', 'ST618', 'ST625', 'ST628', 'ST008']
		},
		'sem-7': {
			id: '7',
			subjects: ['ST728', 'ST729', 'ST723', 'ST727', 'ST730', 'ST722']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08']
	...
	eletivas: {
		...
		'elet-2': {
			credits: 8,
			hasRestrictions: true,
			subjects: ['ST020', 'ST021', 'ST022', 'ST023', 'ST024', 'ST026', 'ST027', 'ST028', 'ST029', 'ST042', 'ST044', 'ST045', 'ST046', 'ST055', 'ST056', 'ST057', 'ST058', 'ST059', 'ST617', 'TT013', 'TT020', 'TT021', 'TT404', 'TT601'],
		},
		'elet-3': {
			credits: 4,
			hasRestrictions: true,
			subjects: ['ST821', 'ST823', 'ST824'],
		},
		'elet-4': {
			credits: 2,
	...
	subjects: {
		...
		'ST821': {
			...
			ementa: 'Trabalho aliando o conhecimento científico com o prático, com a supervisão do CESET nas seguintes áreas: Construção Civil em geral, Escritórios de Projetos Arquitetônicos. Cálculo de Concreto, Madeira e Aço, Planejamento e Orçamento de Obras. Vistoria de Obras e Atividades afins. OBS.: O estágio será supervisionado pelo CESET e servirá como complemento didático para o aluno. Não será responsabilidade do CESET procurar estágio para os alunos.',
			semestre: 1,
