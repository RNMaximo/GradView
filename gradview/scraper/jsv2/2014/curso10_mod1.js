const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EM102', 'MA141', 'F_128', 'MA111', 'EM110', 'QG100']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM200', 'EM103', 'F_328', 'MA211', 'F_129', 'EM306', 'EM240', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['MC102', 'F_428', 'EM335', 'MA311', 'EM360', 'F_329', 'EM330']
		},
		'sem-4': {
			id: '4',
			subjects: ['MA327', 'MS211', 'EM461', 'EM404', 'EM406', 'EM460', 'F_429', 'EM641']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM503', 'EM504', 'EM506', 'EM570', 'EM638', 'EM561', 'EM014', 'EM737']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM607', 'EM909', 'EM733', 'EM535', 'EM670', 'ET017', 'EM665']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM707', 'EM608', 'EM703', 'EM884', 'EM783', 'EM730', 'EM833', 'EM853']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM790', 'BE310', 'EM807', 'ELET08', 'EM984', 'CE738', 'EM740']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM926', 'EM914', 'EM928', 'CE304']
		},
		'sem-10': {
			id: '10',
