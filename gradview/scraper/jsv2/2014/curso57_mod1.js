const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['LA104', 'LG021', 'HL127', 'HL121', 'HL143', 'TL108']
		},
		'sem-2': {
			id: '2',
			subjects: ['ELET02', 'TL222', 'LA204', 'TL118', 'LG022', 'HL236', 'HL220']
		},
		'sem-3': {
			id: '3',
			subjects: ['LA303', 'LG023', 'ELET03', 'HL323']
		},
		'sem-4': {
			id: '4',
			subjects: ['ELET04', 'LA403', 'HL422', 'LG024']
		},
		'sem-5': {
			id: '5',
			subjects: ['LG025', 'ELET05', 'HL135', 'LA504']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'HL245', 'LG026', 'LA602']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'LG027']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08']
		...
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'EL774']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'EL874']
		}
	},
	...
	subjects: {
		...
		'LA303': {
			...
			ementa: 'Estudo e discussão de teorias da interpretação de diferentes tradições teórico-metodológicas que iluminem questões de natureza teórica e prática consideradas relevantes para uma reflexão mais aprofundada sobre leitura/interpretação de textos e demais objetos semióticos que povoam as práticas letradas contemporâneas.',
			semestre: 1,
			vector: {T:2, P:2, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: '',
			color: '#46B99D',
