const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG102', 'CV141', 'CV151', 'CV111', 'CV101', 'MA141', 'MA111', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'CV202', 'F_129', 'F_128', 'CV201', 'MA211', 'ME203']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV351', 'CV332', 'F_229', 'CV301', 'CV312', 'CV321', 'CV311', 'MS211']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV401', 'CV450', 'CV411', 'CV422', 'CV431', 'CV421', 'F_329', 'F_328']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV521', 'ELET05', 'CV511', 'CV522', 'CV541', 'CV531', 'CV532']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV621', 'CV633', 'CV612', 'CV613', 'CV622', 'CV631', 'CV632', 'CV641', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV721', 'CV701', 'CV714', 'CV712', 'CV722', 'CV702', 'CV713', 'CV741']
		},
		'sem-8': {
			id: '8',
		...
		'sem-9': {
			id: '9',
			subjects: ['CV906', 'CV068', 'ELET09', 'CV954']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV951', 'CV903', 'CV902', 'CV955', 'CV900']
		}
	},
