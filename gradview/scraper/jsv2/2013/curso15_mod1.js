const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MD141', 'BS110', 'MD148', 'BS111', 'MD142']
		},
		'sem-2': {
			id: '2',
			subjects: ['MD241', 'BS210', 'MD243', 'MD248', 'MD244', 'MD242']
		},
		'sem-3': {
			id: '3',
			subjects: ['MD542', 'BS320', 'MD348', 'BS330', 'MD344', 'MD342', 'BS340', 'MD343']
		},
		'sem-4': {
			id: '4',
			subjects: ['MD642', 'MD443', 'MD445', 'MD448', 'MD444', 'MD442', 'BS430', 'BS440', 'MD447', 'BS420']
		},
		'sem-5': {
			id: '5',
			subjects: ['MD546', 'MD544', 'MD543', 'MD548']
		},
		'sem-6': {
			id: '6',
			subjects: ['MD646', 'MD644', 'MD643', 'MD648']
		},
		'sem-7': {
			id: '7',
			subjects: ['MD754', 'MD758', 'MD752', 'MD753', 'MD748']
		},
		'sem-8': {
			id: '8',
			subjects: ['MD945', 'MD943', 'MD941', 'MD942', 'MD944']
		},
		'sem-9': {
			id: '9',
			subjects: ['MD134', 'MD132', 'MD127', 'MD131', 'MD136', 'MD138', 'MD133', 'MD139', 'MD135']
		}
	},
	...
	subjects: {
		...
		'MD141': {
			...
			ementa: 'Iniciação ao pensamento crítico relativo ao conhecimento científico e senso comum. A pesquisa científica e suas características. Desenvolvimento de habilidades para a análise crítica e construção do conhecimento científico. A busca da informação e suas evidências científicas.',
			semestre: 1,
		...
		'MD241': {
			...
			ementa: 'Conceitos, definições e aplicações da estatística na pesquisa científica. Análise exploratória de dados. Teste de Hipótese. Probabilidade e variável aleatória. Medidas de frequência e de associação/efeito. Estudos experimentais e observacionais: transversal, corte, caso-controle e ecológico. Meta-análise. Análise crítica e construção do conhecimento científico. A busca da informação e suas evidências científicas.',
			semestre: 1,
