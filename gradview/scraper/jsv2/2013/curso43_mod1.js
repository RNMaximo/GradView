const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['F_128', 'QG101', 'MA111', 'MA141', 'TA109']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_228', 'QO427', 'MC102', 'MA211']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA221', 'QA213', 'QF331', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['TA322', 'BM320', 'TA411', 'TA331', 'TA332']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA421', 'TA516', 'TA514', 'TA431', 'TA513']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA620', 'TA521', 'TA610', 'TA615', 'TA534']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA622', 'TA722', 'ME414', 'TA631', 'MS211', 'TA716']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA826', 'TA824', 'TA611', 'TA724', 'TA731', 'CE138', 'TA619']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA920', 'TA927', 'TA541', 'TA623', 'TA912', 'TA831', 'TA542']
		},
		'sem-10': {
			id: '10',
			subjects: ['F_328', 'TA641', 'TA734', 'TA035']
		},
		'sem-11': {
			id: '11',
			subjects: ['ET016', 'TA736', 'TA725', 'TA741', 'TA030', 'TA836', 'TA832']
		},
		'sem-12': {
			id: '12',
			subjects: ['TA909', 'TA009', 'TA017', 'TA021', 'TA046', 'TA737', 'TA932']
		}
	},
