const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['HZ158', 'HZ141', 'HZ161', 'CE131']
		},
		'sem-2': {
			id: '2',
			subjects: ['HZ258', 'HZ248', 'HZ263', 'ELET02']
		},
		'sem-3': {
			id: '3',
			subjects: ['ELET03', 'HZ345', 'HZ363', 'HZ358']
		},
		'sem-4': {
			id: '4',
		...
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'HZ555']
		},
		'sem-6': {
			id: '6',
			subjects: ['HZ657', 'ELET06', 'HZ631']
		},
		'sem-7': {
			id: '7',
	...
	subjects: {
		...
		'HZ-5-': {
			code: 'HZ-5-',
			name: 'Qualquer Disciplina com codigo HZ-5-',
			ementa: 'Esta disciplina representa qualquer disciplina oferecida pela Unicamp com codigo HZ-5-, onde o - indica uma letra ou numero.',
			semestre: 1,
			vector: {T:0, P:0, L:0, O:0, D:0, HS:0, SL:0, C:1},
			requisitos: '',
			color: '#B98846',
