const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG102', 'CV111', 'CV141', 'MA141', 'CV151', 'MA111', 'MC102', 'CV101']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV202', 'F_129', 'F_128', 'MA211', 'ME203', 'GM420', 'CV201']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV332', 'F_229', 'CV311', 'CV312', 'CV301', 'CV321', 'MS211', 'CV351']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV450', 'CV411', 'F_329', 'F_328', 'CV421', 'CV402', 'CV431', 'CV401', 'CV422']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'CV511', 'CV541', 'CV501', 'CV532', 'CV521', 'CV531', 'CV522']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'CV631', 'CV641', 'CV633', 'CV622', 'CV632', 'CV621', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV713', 'CV712', 'CV714', 'CV741', 'CV701', 'CV722', 'CV702', 'CV721']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV841', 'CV813', 'CV814', 'CV822', 'CV811', 'CV823', 'CV832', 'CV812', 'CV821', 'CV831', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'CV945', 'CV941', 'CV951', 'CV942']
		},
		'sem-10': {
			id: '10',
