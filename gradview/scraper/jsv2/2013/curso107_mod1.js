const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'NT103', 'SL104', 'NT202', 'NT102', 'SL105', 'SL101', 'NT100']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL100', 'NT204', 'SL205', 'NT205', 'NT203', 'SL200']
		},
		'sem-3': {
			id: '3',
			subjects: ['NT306', 'NT305', 'NT304', 'NT402', 'SL303', 'NC400', 'NC301']
		},
		'sem-4': {
			id: '4',
			subjects: ['NT403', 'NT406', 'SL401', 'NT405', 'NT503', 'NT600', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['NT507', 'NT506', 'NT508', 'NT603', 'NT509', 'NT606', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['NT610', 'NT501', 'NT607', 'NT611', 'NT609', 'NT608', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['NT801', 'NT707', 'NT706', 'NT708', 'SL800', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['NT807', 'NT808', 'NT806']
		},
		'sem-9': {
			id: '9',
			subjects: ['NT804', 'NT809', 'NT802']
		}
	},
	...
	subjects: {
		...
		'NT403': {
			...
			ementa: 'Antropologia e Nutrição; alimentação no contexto atual da transformação; discussão sobre significados e valor do alimento; fatores que afetam as escolhas alimentares; breve histórico da \"Educação Nutricional\", diferenciação entre educação e orientação nutricional; aconselhamento nutricional; instituições e atores envolvidos na educação em nutrição; comunicação verbal e não-verbal; conceito de empoderamento; sentido da nutrição a partir de mensagens da mídia; planejamento de atividades educacionais; relato de experiências; desenvolvimento e avaliação de atividades educacionais em Nutrição.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#4688B9',
