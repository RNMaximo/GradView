const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'LE106', 'LE101', 'LE100', 'LE105', 'LE200']
		},
		'sem-2': {
			id: '2',
			subjects: ['LE205', 'LE203', 'LE400', 'LE201', 'NC202', 'LE202', 'NC104']
		},
		'sem-3': {
			id: '3',
			subjects: ['LE303', 'LE300', 'LE500', 'LE103', 'NC301', 'LE302', 'LE301']
		},
		'sem-4': {
			id: '4',
			subjects: ['LE402', 'EU502', 'EU503', 'LE401', 'LE405', 'LE404', 'LE408', 'LE409']
		},
		'sem-5': {
			id: '5',
			subjects: ['EU604', 'EU500', 'EU605', 'LE503', 'LE505', 'LE406', 'LE501', 'LE504', 'NC400', 'EU501']
		},
		'sem-6': {
			id: '6',
			subjects: ['LE609', 'LE608', 'EU602', 'LE602', 'LE600', 'ER600', 'LE704', 'ER201']
		},
		'sem-7': {
			id: '7',
			subjects: ['EU702', 'LE701', 'LE902', 'LE012', 'EU901', 'LE703', 'ELET07', 'LE700']
		},
		'sem-8': {
			id: '8',
			subjects: ['LE804', 'ER801', 'ER700', 'EU704', 'LE802', 'ELET08']
		},
		'sem-9': {
			id: '9',
			subjects: ['ER901', 'ELET09', 'EU010', 'EU802']
		},
		'sem-10': {
			id: '10',
