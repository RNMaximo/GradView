const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['TA109', 'QG101', 'MC102', 'MA111', 'MA141', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['QA213', 'TA221', 'QO427', 'QF331', 'MA211', 'F_228']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA322', 'BM320', 'TA332', 'TA331', 'F_328', 'MA311']
		},
		'sem-4': {
			id: '4',
			subjects: ['TA421', 'TA411', 'ME414', 'MS211', 'ET016', 'TA431', 'CE138']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA521', 'TA513', 'TA516', 'TA541', 'TA534', 'TA514', 'TA542']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA619', 'TA622', 'TA620', 'TA615', 'TA631', 'TA641', 'TA611', 'TA610']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA722', 'TA724', 'TA824', 'TA623', 'TA731', 'TA734', 'TA737', 'TA017', 'TA716']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA920', 'TA826', 'TA030', 'TA736', 'TA831', 'TA836', 'TA832']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA209', 'TA741', 'TA927', 'TA023', 'TA035', 'TA912', 'TA932']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA909', 'TA309', 'TA046']
		}
	},
