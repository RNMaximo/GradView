const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV151', 'CV111', 'QG102', 'CV101', 'CV141', 'MA141', 'MA111', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['GM420', 'MA327', 'MA211', 'CV202', 'CV201', 'F_128', 'F_129', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'CV312', 'CV321', 'CV351', 'CV332', 'CV301', 'F_229', 'MS211']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV411', 'CV421', 'CV431', 'CV401', 'F_328', 'F_329', 'ELET04', 'CV450']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV521', 'CV522', 'CV531', 'ELET05', 'CV541', 'CV532']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV612', 'CV613', 'CV621', 'CV622', 'CV641', 'CV632', 'CV633', 'CV631', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV721', 'CV714', 'CV722', 'CV702', 'CV701', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV814', 'CV813', 'CV823', 'CV822', 'CV832', 'CV821', 'CV811', 'ELET08', 'CV812', 'CV841', 'CV831']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'ELET09', 'CV951']
		},
		'sem-10': {
			id: '10',
