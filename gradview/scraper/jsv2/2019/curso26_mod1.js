const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AC110', 'AC115', 'AC123', 'AC109', 'AC129', 'AC218', 'AC316']
		},
		'sem-2': {
			id: '2',
			subjects: ['AC210', 'AC211', 'AC223', 'AC209', 'AC315', 'AC214', 'AC215']
		},
		'sem-3': {
			id: '3',
			subjects: ['AC331', 'AC340', 'AC323', 'AC105', 'AC415', 'AC890']
		},
		'sem-4': {
			id: '4',
			subjects: ['AC120', 'AC441', 'AC423', 'AC440', 'AC414', 'AC205', 'AC317']
		},
		'sem-5': {
			id: '5',
			subjects: ['AC321', 'AC555', 'AC557', 'AC160']
		},
		'sem-6': {
			id: '6',
			subjects: ['AC657', 'AC121', 'AC260', 'AC666']
		},
		'sem-7': {
			id: '7',
			subjects: ['AC757', 'AC360', 'ELET07', 'AC777']
		},
		'sem-8': {
			id: '8',
			subjects: ['AC888', 'AC857', 'ELET08', 'AC887']
		}
	},
