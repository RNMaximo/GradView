const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC400', 'GL100', 'PG100', 'GL203', 'NC103']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'GL201', 'PG200', 'PG300', 'PG201']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL102', 'NC104', 'PG301', 'GL202', 'NC301']
		},
		'sem-4': {
			id: '4',
			subjects: ['ER201', 'GL303', 'PG400', 'GL603', 'GL608', 'PG800']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG502', 'PG501', 'PG500', 'GL507', 'PG710']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL304', 'ER401', 'PG600', 'GL502', 'PG701']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL710', 'GL701', 'PG704', 'PG810', 'ELET07', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'GL801', 'PG801']
		}
	},
