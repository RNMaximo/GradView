const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AC123', 'AC109', 'AC110', 'AC115', 'AC129', 'AC218', 'AC316']
		},
		'sem-2': {
			id: '2',
			subjects: ['AC223', 'AC209', 'AC210', 'AC214', 'AC211', 'AC315', 'AC215']
		},
		'sem-3': {
			id: '3',
			subjects: ['AC323', 'AC340', 'AC890', 'AC105', 'AC331', 'AC415']
		},
		'sem-4': {
			id: '4',
			subjects: ['AC423', 'AC441', 'AC317', 'AC120', 'AC205', 'AC414', 'AC440']
		},
		'sem-5': {
			id: '5',
			subjects: ['AC555', 'AC557', 'AC321', 'AC160']
		},
		'sem-6': {
			id: '6',
			subjects: ['AC666', 'AC260', 'AC121', 'AC657']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'AC777', 'AC360', 'AC757']
		},
		'sem-8': {
			id: '8',
			subjects: ['AC887', 'AC888', 'AC857', 'ELET08']
		}
	},
