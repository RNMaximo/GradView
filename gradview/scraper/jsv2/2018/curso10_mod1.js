const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG122', 'QG111', 'EM102', 'MA111', 'MA141', 'F_128', 'EM110']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM200', 'EM240', 'F_129', 'EM306', 'F_328', 'MA211', 'EM103', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'F_428', 'EM335', 'F_329', 'MA311', 'MC102', 'EM360']
		},
		'sem-4': {
			id: '4',
			subjects: ['F_429', 'EM641', 'MA327', 'EM406', 'MS211', 'EM404', 'EM460', 'EM461']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM737', 'EM638', 'EM506', 'EM503', 'EM561', 'EM504', 'EM570', 'EM014']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM909', 'EM665', 'EM733', 'EM535', 'ET017', 'EM670', 'EM607']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM833', 'EM608', 'EM730', 'EM783', 'EM853', 'EM707', 'EM703', 'EM884']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'EM740', 'EM790', 'BE310', 'CE738', 'EM807', 'EM984']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE304', 'EM926', 'EM928', 'ELET09', 'EM105']
		},
		'sem-10': {
			id: '10',
			subjects: ['EM916', 'EM106']
		}
	},
