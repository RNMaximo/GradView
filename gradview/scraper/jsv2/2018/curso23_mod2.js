const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AD021', 'AD013', 'AD030', 'AD135', 'AD421', 'AD116', 'AR101', 'AD041']
		},
		'sem-2': {
			id: '2',
			subjects: ['AD022', 'AD014', 'AD042', 'AD015', 'AD521', 'BF223', 'EL683', 'ELET02']
		},
		'sem-3': {
			id: '3',
			subjects: ['AD016', 'AD023', 'AD335', 'ELET03', 'AD601', 'EL511', 'AD051', 'AR301', 'EF920']
		},
		'sem-4': {
			id: '4',
			subjects: ['AD044', 'EL213', 'AD435', 'AD017', 'AD052', 'ELET04', 'EL212', 'EF921', 'AD213']
		},
		'sem-5': {
			id: '5',
			subjects: ['AD045', 'AD025', 'ELET05', 'EL774', 'AD053', 'AR601', 'AD071']
		},
		'sem-6': {
			id: '6',
			subjects: ['AD046', 'AD026', 'EL874', 'AD072', 'ELET06', 'AD054', 'AD620']
		},
		'sem-7': {
			id: '7',
			subjects: ['AD047', 'AD061', 'AD081', 'ELET07', 'AD055']
		},
		'sem-8': {
			id: '8',
	...
	subjects: {
		...
		'AD014': {
			...
			ementa: 'Desenvolvimento de atividades em Consciência Corporal e Expressão e Movimento, de modo que seus conteúdos sejam integrados as técnicas de dança. Realização de outros trabalhos que propiciem leituras corporais e ênfase na fundamentação estética das relações entre as linguagens artísticas. Abordagem dessas temáticas – corpo, movimento, a dança e as artes - no contexto escolar. Aprofundamento e desenvolvimento do Ateliê de Prática em Dança I.',
			semestre: 1,
			vector: {T:0, P:4, L:0, O:4, D:0, HS:8, SL:4, C:8},
			requisitos: ['AD013'],
			color: '#B94687',
