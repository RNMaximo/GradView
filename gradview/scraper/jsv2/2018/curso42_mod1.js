const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC102', 'F_128', 'MA141', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['MC202', 'MC009', 'MA211', 'MA327', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['MC322', 'ME323', 'MA311', 'MC358']
		},
		'sem-4': {
			id: '4',
			subjects: ['MC750', 'MC602', 'F_328', 'MC458', 'F_329']
		},
		'sem-5': {
			id: '5',
			subjects: ['MC536', 'MC404', 'MC426', 'MC558']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'MC504', 'MS211']
		},
		'sem-7': {
			id: '7',
			subjects: ['MC832', 'MC732', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['MC833', 'MC714', 'MC921', 'ELET08', 'CE839']
		},
		'sem-9': {
			id: '9',
