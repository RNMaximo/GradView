const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['DB011', 'DM012', 'DM011', 'DS011', 'DM013']
		},
		'sem-2': {
			id: '2',
			subjects: ['DB021', 'DM022', 'DM021', 'DM024']
		},
		'sem-3': {
			id: '3',
			subjects: ['DM031', 'DM032', 'DM035', 'DM034', 'DM036']
		},
		'sem-4': {
			id: '4',
			subjects: ['DM041', 'DM042', 'DM045', 'DM046', 'DM043']
		},
		'sem-5': {
			id: '5',
			subjects: ['DM057', 'DM051', 'DM052', 'DC052']
		},
		'sem-6': {
			id: '6',
			subjects: ['DM067', 'DC062', 'DS062', 'DS061', 'DM068']
		},
		'sem-7': {
			id: '7',
			subjects: ['DC072', 'DM075', 'DM074', 'DS071', 'DC073', 'DM078']
		},
		'sem-8': {
			id: '8',
			subjects: ['DC082', 'DM084', 'DM085', 'DC083', 'DM083']
		},
		'sem-9': {
			id: '9',
			subjects: ['DC092', 'DE091', 'DC093', 'DS091']
		},
		'sem-10': {
			id: '10',
			subjects: ['DC102', 'DE101', 'DC103', 'DS101']
		}
	},
	...
	subjects: {
		...
		'DM031': {
			code: 'DM031',
			name: 'Cárie III',
			ementa: 'Programa integrado de Anatomia, Bioquímica, Dentística, Odontologia Infantil, Odontologia Preventiva, Orientação profissional, Psicologia, Radiologia, Materiais Dentários e Semiologia para o estudo dos procedimentos e métodos clínicos e comportamentais de atuação para a prevenção da cárie dentária e preparo para o exercício das atividades clínicas necessárias ao tratamento da doença.',
			semestre: 1,
