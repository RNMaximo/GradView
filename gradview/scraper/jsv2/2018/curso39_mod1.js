const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG101', 'EQ101', 'F_128', 'MA111', 'MA141']
		},
		'sem-2': {
			id: '2',
			subjects: ['QO427', 'QG102', 'MA211', 'ME414', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['QO327', 'EQ481', 'MA311', 'CE304']
		},
		'sem-4': {
			id: '4',
			subjects: ['QA313', 'EM312', 'F_315', 'F_328']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM423', 'EQ415', 'EQ541', 'MC102', 'F_329']
		},
		'sem-6': {
			id: '6',
			subjects: ['EQ515', 'QI244', 'EQ583', 'MS211', 'QI242', 'GT001']
		},
		'sem-7': {
			id: '7',
			subjects: ['EQ712', 'EQ651', 'EQ502', 'EQ601', 'EQ641']
		},
		'sem-8': {
			id: '8',
			subjects: ['EQ812', 'EQ791', 'EQ741', 'EQ701', 'EQ751']
		},
		'sem-9': {
			id: '9',
			subjects: ['EQ801', 'EQ852', 'EQ771', 'EQ531', 'ET016']
		},
		'sem-10': {
			id: '10',
			subjects: ['EQ991', 'EQ861', 'EQ817', 'EQ622', 'ELET10']
		},
		'sem-11': {
			id: '11',
			subjects: ['EQ950', 'EQ922', 'EQ883', 'ELET11']
		},
		'sem-12': {
			id: '12',
			subjects: ['EQ050', 'EQ004', 'EQ902']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['EI---', 'EQ022', 'EQ023', 'EQ024', 'EQ025', 'EQ026', 'EQ027', 'EQ028', 'EQ029', 'EQ030', 'EQ035', 'EQ036', 'EQ037', 'EQ041', 'EQ042', 'EQ043', 'EQ044', 'EQ045', 'EQ046', 'EQ047', 'EQ048', 'EQ061', 'EQ062', 'EQ081', 'EQ082', 'EQ961'],
		},
		'elet-2': {
			credits: 4,
