const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['TA109', 'QG101', 'F_128', 'MA111', 'MA141']
		},
		'sem-2': {
			id: '2',
			subjects: ['MC102', 'QO427', 'F_228', 'MA211']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA221', 'MA311', 'QA213', 'QF331']
		},
		'sem-4': {
			id: '4',
			subjects: ['TA322', 'TA411', 'BM320', 'TA331', 'TA332']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA421', 'TA516', 'TA431', 'TA513', 'TA514']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA521', 'TA620', 'TA615', 'TA534', 'TA610']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA722', 'TA622', 'TA716', 'TA631', 'MS211', 'ME414']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA824', 'TA826', 'TA724', 'TA619', 'TA611', 'TA731', 'CE138']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA920', 'TA927', 'TA623', 'TA831', 'TA912', 'TA541', 'TA542']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA734', 'TA641', 'F_328', 'TA035']
		},
		'sem-11': {
			id: '11',
			subjects: ['TA836', 'TA832', 'TA736', 'TA741', 'ET016', 'TA030']
		},
		'sem-12': {
			id: '12',
			subjects: ['TA909', 'TA932', 'TA737', 'TA023', 'TA017', 'TA046', 'TA009']
		}
	},
