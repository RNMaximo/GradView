const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['BZ183', 'BG181', 'QG107', 'EL212', 'BC183']
		},
		'sem-2': {
			id: '2',
			subjects: ['BT283', 'BZ281', 'BT282', 'BZ283', 'BC283', 'BB281', 'EL683']
		},
		'sem-3': {
			id: '3',
			subjects: ['BZ383', 'BZ382', 'BT383', 'MS380', 'BL033', 'BT384', 'BD692', 'BB381']
		},
		'sem-4': {
			id: '4',
			subjects: ['BL600', 'BF483', 'BT483', 'BG200', 'BA480', 'BH482', 'BT484']
		},
		'sem-5': {
			id: '5',
			subjects: ['BL583', 'BF583', 'F_107', 'BE581', 'BI520']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'BG481', 'BV620', 'BE681', 'BZ681', 'BH620', 'EL511', 'BZ682', 'BL028', 'BL035']
		},
		'sem-7': {
			id: '7',
			subjects: ['BL300', 'BG520', 'FN468', 'BL682', 'EL774', 'BV720', 'GM280']
		},
		'sem-8': {
			id: '8',
			subjects: ['BP820', 'BT681', 'BT880', 'GM450', 'BT885', 'ELET08', 'EL885', 'BL030', 'BD520']
		},
		'sem-9': {
			id: '9',
			subjects: ['EL142', 'BM720', 'BL034', 'BH780', 'ELET09', 'BD694', 'EL876']
		},
		'sem-10': {
			id: '10',
			subjects: ['EL485', 'BG680', 'ELET10', 'BL029', 'BD792', 'BL031']
		}
	},
	...
	subjects: {
		...
		'BV620': {
			...
			ementa: 'Relações hídricas, absorção iônica e transporte de solutos, nutrição mineral, assimilação do nitrogênio, fixação simbiótica do nitrogênio, fotossíntese, relações fonte-dreno, respiração.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#B97246',
