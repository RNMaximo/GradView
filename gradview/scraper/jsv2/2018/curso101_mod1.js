const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['LE105', 'LE106', 'LE101', 'LE200', 'NC103', 'LE100']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC104', 'LE203', 'LE400', 'LE201', 'NC202', 'LE202', 'LE205']
		},
		'sem-3': {
			id: '3',
			subjects: ['LE300', 'NC301', 'LE303', 'LE500', 'LE301', 'LE302', 'LE103']
		},
		'sem-4': {
			id: '4',
			subjects: ['LE409', 'LE402', 'EU503', 'LE408', 'LE401', 'LE405', 'EU502', 'LE404']
		},
		'sem-5': {
			id: '5',
			subjects: ['EU500', 'LE505', 'EU605', 'LE501', 'LE504', 'LE503', 'LE406', 'EU604', 'EU501', 'NC400']
		},
		'sem-6': {
			id: '6',
			subjects: ['LE609', 'ER600', 'EU602', 'LE602', 'LE704', 'LE600', 'ER201', 'LE608']
		},
		'sem-7': {
			id: '7',
			subjects: ['LE700', 'LE701', 'LE703', 'LE902', 'ELET07', 'EU901', 'LE012', 'EU702']
		},
		'sem-8': {
			id: '8',
			subjects: ['LE804', 'ER801', 'ELET08', 'ER700', 'LE802', 'EU704']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'ER901', 'EU010', 'EU802']
		},
		'sem-10': {
			id: '10',
