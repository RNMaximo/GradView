const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL100', 'NC400', 'GL101', 'PG100']
		},
		'sem-2': {
			id: '2',
			subjects: ['PG201', 'GL201', 'GL203', 'GL302', 'PG200']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC104', 'NC301', 'PG300', 'GL202', 'PG301']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL303', 'GL608', 'ER201', 'GL603', 'PG400', 'PG800']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG710', 'PG502', 'PG500', 'GL502', 'PG501']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL304', 'ER401', 'PG600', 'PG701', 'GL900', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'PG810', 'PG704', 'GL701', 'ELET07', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL800', 'ELET08', 'PG801', 'GL801']
		}
	},
