const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MA141', 'MA111', 'F_128', 'QG101', 'TA109']
		},
		'sem-2': {
			id: '2',
			subjects: ['MA211', 'MC102', 'F_228', 'QO427']
		},
		'sem-3': {
			id: '3',
		...
		'sem-4': {
			id: '4',
			subjects: ['TA331', 'TA332', 'TA322', 'TA411', 'BM320']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA431', 'TA514', 'TA513', 'TA516', 'TA421']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA534', 'TA610', 'TA615', 'TA620', 'TA521']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA631', 'MS211', 'TA716', 'TA622', 'TA722', 'ME414']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA731', 'TA611', 'TA724', 'TA826', 'TA824', 'TA619', 'CE138']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA831', 'TA912', 'TA623', 'TA927', 'TA920', 'TA542', 'TA541']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA035', 'TA734', 'F_328', 'TA641']
		},
		'sem-11': {
			id: '11',
			subjects: ['TA030', 'TA736', 'TA741', 'ET016', 'TA836', 'TA832']
		},
		'sem-12': {
			id: '12',
			subjects: ['TA737', 'TA023', 'TA017', 'TA909', 'TA046', 'TA932', 'TA009']
		}
	},
