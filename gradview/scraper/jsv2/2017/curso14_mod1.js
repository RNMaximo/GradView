const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['DM011', 'DB011', 'DS011', 'DM012', 'DM013']
		},
		'sem-2': {
			id: '2',
			subjects: ['DM021', 'DB021', 'DM022', 'DM024']
		},
		'sem-3': {
			id: '3',
			subjects: ['DM031', 'DM035', 'DM032', 'DM034', 'DM036']
		},
		'sem-4': {
			id: '4',
			subjects: ['DM041', 'DM045', 'DM042', 'DM043', 'DM046']
		},
		'sem-5': {
			id: '5',
		...
		'sem-6': {
			id: '6',
			subjects: ['DS061', 'DS062', 'DC061', 'DM067', 'DM068']
		},
		'sem-7': {
			id: '7',
			subjects: ['DS071', 'DM075', 'DM074', 'DC071', 'DM078']
		},
		'sem-8': {
			id: '8',
			subjects: ['DM084', 'DM085', 'DC081', 'DM083']
		},
		'sem-9': {
			id: '9',
	...
	subjects: {
		...
		'DM036': {
			...
			ementa: 'Programa integrado de Radiologia, Anatomia, Terapêutica Medicamentosa e Anestesiologia para o estudo das técnicas existentes para a realização de radiografias intrabucais, adquirir noções de interpretação das estruturas maxilomandibulares, assim como estudar nervo trigêmeo, filmes e processamento radiográfico e soluções processadoras. Estudo das emergências médico-odontológicas, cuidados preventivos e medidas de pronto atendimento em nível ambulatorial. Estudo da farmacologia dos anestésicos locais.',
			semestre: 1,
		...
		'DC071': {
			...
			ementa: 'Aplicação prática, através de atividades clínicas, dos conhecimentos adquiridos nas disciplinas pré-requisitos, objetivando a prevenção e/ou tratamento de anormalidades odontológicas e realização de procedimentos relacionados à Cirurgia, Periodontia, Endodontia, Dentística, Odontopediatria, Ortodontia, Semiologia e Prótese Parcial Removível. Plantão de Urgência de 20 horas. Estágio Clínico Supervisionado de 160 horas.',
			semestre: 1,
		...
		'DM084': {
			...
			ementa: 'Programa Integrada de Prótese Fixa e Materiais Dentários desenvolvido para a confecção de Próteses Parciais Fixas.',
			semestre: 1,
		...
		'DC091': {
			...
			ementa: 'Aplicação prática, através de atividades clínicas, dos conhecimentos adquiridos nas disciplinas pré-requisitos, objetivando a prevenção e/ou tratamento de anormalidades odontológicas e realização de procedimentos de: Cirurgia, Periodontia, Dentística, Endodontia, Odontopediatria, Ortodontia, Prótese Total, Parcial Removível e Prótese Fixa. Plantões de Urgência de 20hs.Estágio Clínico Supervisionado de 280 horas.',
			semestre: 1,
		...
		'DC101': {
			...
			ementa: 'Aplicação prática, através de atividades clínicas, dos conhecimentos adquiridos nas disciplinas pré-requisitos, objetivando a prevenção e/ou tratamento de anormalidades odontológicas e procedimentos relacionados à Cirurgia, Periodontia, Endodontia, Dentística, Odontopediatria, Ortodontia e Prótese Total, Prótese Parcial Removível e Prótese Fixa. Plantões de Urgência de 20 horas. Estágio Clínico Supervisionado de 220 horas.',
			semestre: 1,
