const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV151', 'CV111', 'CV101', 'MA141', 'MA111', 'MC102', 'QG102', 'CV141']
		},
		'sem-2': {
			id: '2',
			subjects: ['MA327', 'MA211', 'CV201', 'GM420', 'ME414', 'CV202', 'F_128', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV312', 'CV332', 'MA311', 'CV321', 'CV351', 'MS211', 'F_229', 'CV301']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV411', 'CV431', 'CV422', 'CV402', 'CV401', 'F_329', 'CV421', 'F_328', 'CV450']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV511', 'ELET05', 'CV521', 'CV501', 'CV522', 'CV532', 'CV541', 'CV531']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV612', 'CV633', 'CV631', 'CV621', 'CV613', 'CV622', 'ELET06', 'CV632', 'CV641']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV714', 'CV713', 'CV701', 'CV721', 'CV722', 'CV702', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV813', 'CV812', 'CV814', 'CV811', 'CV823', 'CV821', 'CV841', 'CV832', 'CV822', 'ELET08', 'CV831']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'CV068', 'CV906', 'ELET09']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV955', 'CV951', 'CV900', 'CV902', 'CV903']
		}
	},
