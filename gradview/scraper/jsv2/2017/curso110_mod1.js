const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GL101', 'NC103', 'NC400', 'PG100', 'GL100']
		},
		'sem-2': {
			id: '2',
			subjects: ['PG201', 'GL203', 'PG200', 'GL302', 'GL201']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL202', 'PG300', 'PG301', 'NC301', 'GL301']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL603', 'PG800', 'ER201', 'PG400', 'ER401', 'GL400']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL502', 'PG704', 'PG501', 'PG502', 'PG500']
		},
		'sem-6': {
			id: '6',
			subjects: ['PG701', 'PG801', 'GL608', 'GL900', 'PG600', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL701', 'PG709', 'GL601', 'GL700', 'PG710', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL801', 'PG810', 'ELET08', 'GL800']
		}
	},
