const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AU991', 'AU221', 'HH788', 'AP211', 'AP111', 'MS123', 'AU110']
		},
		'sem-2': {
			id: '2',
			subjects: ['AU992', 'AU212', 'AU223', 'AP120', 'AP112', 'HH804']
		},
		'sem-3': {
			id: '3',
			subjects: ['AU601', 'AU302', 'HH789', 'AU811', 'ELET03', 'AU501', 'AP115', 'AU993']
		},
		'sem-4': {
			id: '4',
			subjects: ['AP314', 'AU994', 'AU145', 'AU812', 'AU605', 'HH805', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['AU146', 'AU609', 'AU995', 'AP213', 'AU401', 'AU817']
		},
		'sem-6': {
			id: '6',
			subjects: ['AP741', 'AU996', 'AU303', 'AU613', 'AU402', 'AU502', 'AU147']
		},
		'sem-7': {
			id: '7',
			subjects: ['AP742', 'AU997', 'AU144', 'HH806', 'AU405']
		},
		'sem-8': {
			id: '8',
			subjects: ['AU612', 'AU148', 'AU610', 'AU998', 'AU406', 'AU504', 'AP216']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'AU225', 'AU614', 'AU814', 'AU404', 'AP217', 'HH796', 'AU999']
		},
		'sem-10': {
			id: '10',
			subjects: ['AU149', 'AU815', 'AU990', 'AU917', 'AU713', 'AU816']
		},
		'sem-11': {
			id: '11',
			subjects: ['ELET11', 'AU023', 'AU001']
		},
		'sem-12': {
			id: '12',
			subjects: ['AU020']
	...
	eletivas: {
		...
		'elet-2': {
			credits: 12,
			hasRestrictions: true,
			subjects: ['AU191', 'AU192', 'AU193', 'AU194', 'AU195', 'AU196', 'AU197', 'AU198', 'AU199', 'AU311', 'AU312', 'AU313', 'AU700', 'AU701', 'AU901', 'AU902', 'AU903', 'AU904', 'AU905', 'AU906', 'AU907', 'AU908', 'AU909', 'AU910', 'AU911', 'AU912', 'AU913', 'AU915', 'AU916', 'AU920', 'AU921', 'AU922', 'AU923', 'AU924', 'AU925'],
		},
	},
	...
	subjects: {
		...
		'AU905': {
			code: 'AU905',
			name: 'Saneamento Ambiental e Saúde Pública',
			ementa: 'Fundamentos de Saneamento e de Saúde Pública. Qualidade socioambiental do meio. Impactos Ambientais dos processos urbanos. Legislação Pertinente. Estudo de Caso.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['AA440'],
			color: '#46B995',
