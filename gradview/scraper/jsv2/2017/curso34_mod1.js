const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['F_129', 'F_128', 'MC102', 'MA141', 'MA111', 'QG111', 'HZ291', 'QG122']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_229', 'F_228', 'MC202', 'MA211', 'MA327', 'LA122']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_329', 'MC302', 'F_315', 'MA311', 'F_328', 'EA513']
		},
		'sem-4': {
			id: '4',
			subjects: ['F_429', 'MC358', 'EM423', 'MC404', 'F_428', 'EA772']
		},
		'sem-5': {
			id: '5',
			subjects: ['EE532', 'MC750', 'MC458', 'ME323', 'EE400', 'MC613']
		},
		'sem-6': {
			id: '6',
			subjects: ['EE534', 'MC426', 'MC536', 'MS211', 'MC558', 'MC732']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'BE310', 'CE304', 'MC504', 'MC658', 'MC733']
		},
		'sem-8': {
			id: '8',
			subjects: ['CE839', 'MC832', 'ELET08', 'CE838']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'MC833', 'MC921', 'MC714', 'CE738']
		},
		'sem-10': {
			id: '10',
	...
	eletivas: {
		...
		'elet-2': {
			...
			subjects: ['MC019', 'MC020', 'MC032', 'MC033', 'MC040', 'MC041', 'MC050', 'MC051'],
		},
		'elet-3': {
			credits: 12,
			hasRestrictions: true,
		...
		'elet-4': {
			credits: 12,
			hasRestrictions: true,
			subjects: ['MC346', 'MC521', 'MC621', 'MC721', 'MC821', 'MC886', 'MC896', 'MC906', 'MC919', 'MC920', 'MC937', 'MC940', 'MC949', 'MC950', 'MC959', 'MC970', 'MC971'],
		},
	},
