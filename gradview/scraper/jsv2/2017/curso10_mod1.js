const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EM110', 'EM102', 'QG100', 'F_128', 'MA141', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM103', 'EM200', 'EM240', 'F_129', 'F_328', 'EM306', 'MA211', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'EM335', 'MC102', 'F_329', 'F_428', 'MA311', 'EM360']
		},
		'sem-4': {
			id: '4',
			subjects: ['F_429', 'EM641', 'EM406', 'MS211', 'MA327', 'EM461', 'EM404', 'EM460']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM638', 'EM506', 'EM014', 'EM737', 'EM503', 'EM561', 'EM570', 'EM504']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM909', 'EM535', 'EM665', 'EM733', 'ET017', 'EM670', 'EM607']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM608', 'EM730', 'EM833', 'EM783', 'EM707', 'EM853', 'EM703', 'EM884']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM790', 'EM740', 'CE738', 'BE310', 'ELET08', 'EM807', 'EM984']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM926', 'EM105', 'ELET09', 'EM928', 'CE304']
		},
		'sem-10': {
			id: '10',
