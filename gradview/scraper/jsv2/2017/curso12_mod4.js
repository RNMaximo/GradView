const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV141', 'QG102', 'MA141', 'CV151', 'CV111', 'MA111', 'CV101', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV202', 'MA327', 'MA211', 'F_128', 'F_129', 'GM420', 'ME414', 'CV201']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV332', 'CV351', 'MA311', 'F_229', 'CV301', 'MS211', 'CV321', 'CV312']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV422', 'CV401', 'F_328', 'CV450', 'CV411', 'F_329', 'CV421', 'CV402', 'CV431']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'CV541', 'CV511', 'CV521', 'CV532', 'CV522', 'CV501', 'CV531']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV633', 'CV613', 'CV612', 'CV621', 'CV641', 'ELET06', 'CV622', 'CV632', 'CV631']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV714', 'CV713', 'CV712', 'CV721', 'CV701', 'CV722', 'CV741', 'CV702']
		},
		'sem-8': {
			id: '8',
		...
		'sem-9': {
			id: '9',
			subjects: ['CV941', 'CV942', 'CV945', 'CV954', 'CV951']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'CV943', 'CV944', 'CV955']
		}
	},
