const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC103', 'GL101', 'GL100', 'GL604', 'NC400']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC100', 'ELET02', 'GL201', 'GL202', 'GL203']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'GL302', 'GL301', 'GL300', 'GL600']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL403', 'LE803', 'GL400', 'GL603', 'LE702', 'GL200']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL504', 'ELET05', 'GL506', 'GL502', 'GL505', 'GL501']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL605', 'GL606', 'GL607', 'ER200', 'GL601', 'GL602', 'GL900']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'ELET07', 'GL701', 'PG704', 'PG703', 'PG701', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['PG802', 'GL800', 'GL801', 'PG801', 'PG809', 'ELET08']
		}
	},
