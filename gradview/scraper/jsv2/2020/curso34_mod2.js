const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['F_129', 'F_128', 'MA111', 'MC102', 'MA141', 'QG122', 'QG111', 'HZ291']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_229', 'F_228', 'LA122', 'MA211', 'MA327', 'MC202']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_329', 'F_315', 'F_328', 'MA311', 'EA513', 'MC322']
		},
		'sem-4': {
			id: '4',
			subjects: ['EA772', 'F_429', 'MC404', 'F_428', 'EM423', 'MC358']
		},
		'sem-5': {
			id: '5',
			subjects: ['EA773', 'EA876', 'EA871', 'EE400', 'EE532', 'MC458', 'ME323']
		},
		'sem-6': {
			id: '6',
			subjects: ['EA872', 'EA960', 'EA202', 'MS211', 'EE534', 'EA614']
		},
		'sem-7': {
			id: '7',
			subjects: ['EA979', 'EA201', 'EA074', 'EA616', 'EA619', 'EE881']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'EA072', 'EA080', 'EA721', 'EA722', 'EE882', 'BE310']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE304', 'EA006', 'CE838', 'EA044', 'EE610', 'ELET09']
		},
		'sem-10': {
			id: '10',
			subjects: ['ELET10', 'CE738']
		}
	},
	...
	subjects: {
		...
		'EA202': {
			code: 'EA202',
			name: 'Engenharia de Software: Teoria e Prática',
		...
		'EA872': {
			...
			ementa: 'Experiências sobre montadores, carregadores, compiladores e sistemas operacionais.',
			semestre: 1,
			vector: {T:0, P:0, L:2, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['EA876'],
			color: '#467CB9',
		...
		'EA201': {
			code: 'EA201',
			name: 'Sistemas Embarcados: Teoria e Prática',
			ementa: 'Introdução. Interligação entre módulos. Ligação com o barramento interno. Memória. Organização da memória. Microprocessador. Coprocessadores e controladores. Entrada/Saída. Periféricos. Aplicações de microcontroladores em instrumentação e controle de tempo real. Aspectos práticos de programação de microcontroladores.',
			semestre: 1,
			vector: {T:4, P:0, L:0, O:2, D:0, HS:6, SL:4, C:6},
			requisitos: ['EA773', 'EA871', 'EE534', 'MC404'],
			color: '#806B80',
			obligatory: true
		},
		'EA616': {
		...
		'ELET08': {
			...
			semestre: 1,
			vector: {T:0, P:0, L:0, O:0, D:0, HS:0, SL:0, C:7},
			requisitos: '',
			color: '#000000',
			obligatory: true
		},
