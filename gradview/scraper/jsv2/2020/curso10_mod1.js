const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG111', 'QG122', 'EM110', 'EM102', 'MA141', 'MA111', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM200', 'EM240', 'F_129', 'EM103', 'EM306', 'MA211', 'F_328', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM330', 'EM335', 'MC102', 'F_329', 'EM360', 'MA311', 'F_428']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM641', 'F_429', 'MS211', 'EM460', 'EM406', 'MA327', 'EM404', 'EM461']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM638', 'EM014', 'EM737', 'EM506', 'EM503', 'EM570', 'EM504', 'EM561']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM909', 'EM535', 'EM733', 'EM665', 'ET017', 'EM607', 'EM670']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM608', 'EM730', 'EM833', 'EM884', 'EM853', 'EM703', 'EM707', 'EM783']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM790', 'EM740', 'ELET08', 'BE310', 'EM984', 'CE738', 'EM807']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM926', 'EM928', 'ELET09', 'EM105', 'CE304']
		},
		'sem-10': {
			id: '10',
