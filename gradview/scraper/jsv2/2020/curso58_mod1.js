const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['BH132', 'F_105', 'FN102', 'FN104', 'MD223', 'FN103', 'BH131', 'FN101', 'BA132', 'HL111']
		},
		'sem-2': {
			id: '2',
			subjects: ['FN504', 'FN205', 'FN208', 'FN203', 'BS280', 'FN710', 'HL221', 'FN209', 'FN207', 'HL201', 'ELET02']
		},
		'sem-3': {
			id: '3',
			subjects: ['FN604', 'HL304', 'FN307', 'FN304', 'HL321', 'MD350', 'FN301', 'BF180', 'FN302', 'FN306', 'MD215']
		},
		'sem-4': {
			id: '4',
			subjects: ['FN408', 'MD410', 'FN401', 'FN404', 'FN413', 'FN409', 'FN410', 'FN400', 'HL832', 'FN420', 'FN437', 'FN904', 'HL311']
		},
		'sem-5': {
			id: '5',
			subjects: ['FN501', 'FN510', 'FN511', 'FN512', 'FN536', 'FN537', 'FN539', 'FN543', 'FN704', 'HL503', 'ELET05']
		},
		'sem-6': {
			id: '6',
		...
		'sem-7': {
			id: '7',
			subjects: ['FN705', 'FN502', 'FN743', 'FN701', 'FN742', 'FN736', 'FN744', 'FN206', 'FN745']
		},
		'sem-8': {
			id: '8',
			subjects: ['FN805', 'FN842', 'FN843', 'FN836', 'FN845', 'FN908', 'FN844']
		}
	},
	...
	subjects: {
		...
		'FN410': {
			code: 'FN410',
			name: 'Processos Terapêuticos Fonoaudiológicos da Surdez',
			ementa: 'Fornecer subsídios teóricos e práticos sobre o processo clínico-terapêutico fonoaudiológico da surdez.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
			color: '#6046B9',
		...
		'FN510': {
			...
			ementa: 'Fornecer subsídios teóricos sobre o processo de aquisição e desenvolvimento da leitura-escrita, relacionando-se o processo clínico-terapêutico ao educacional e ao contexto linguistico da LIBRAS. E, partindo das questões linguísticas, abordar a relação sujeito/língua/identidade na surdez.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['FN404'],
			color: '#B95646',
