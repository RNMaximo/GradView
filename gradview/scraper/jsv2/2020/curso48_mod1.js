const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AU091', 'AP211', 'AP111', 'AU991', 'MS123', 'AU221', 'HH788']
		},
		'sem-2': {
			id: '2',
			subjects: ['AU992', 'AP213', 'AP112', 'HH804', 'AU223', 'AU212']
		},
		'sem-3': {
			id: '3',
			subjects: ['AU993', 'ELET03', 'AU601', 'AU811', 'AU501', 'AU302', 'HH789', 'AP115']
		},
		'sem-4': {
			id: '4',
			subjects: ['AU605', 'ELET04', 'AU994', 'AU812', 'AU145', 'HH805', 'AP314']
		},
		'sem-5': {
			id: '5',
			subjects: ['AU995', 'AU609', 'AP120', 'AU401', 'AU817', 'AU146']
		},
		'sem-6': {
			id: '6',
			subjects: ['AU303', 'AU996', 'AP741', 'AU402', 'AU502', 'AU147', 'AU613']
		},
		'sem-7': {
			id: '7',
			subjects: ['HH806', 'AU997', 'AP742', 'AU405', 'AU144']
		},
		'sem-8': {
			id: '8',
			subjects: ['AU998', 'AU610', 'AU612', 'AU406', 'AU504', 'AP216', 'AU148']
		},
		'sem-9': {
			id: '9',
			subjects: ['ELET09', 'AU225', 'AU404', 'AU814', 'AU999', 'AP217', 'AU713', 'HH796']
		},
		'sem-10': {
			id: '10',
			subjects: ['AU149', 'AU990', 'AU815', 'AU917', 'AU816', 'AU614']
		},
		'sem-11': {
			id: '11',
			subjects: ['AU001', 'ELET11', 'AU023']
		},
		'sem-12': {
			id: '12',
			subjects: ['AU020']
	...
	subjects: {
		...
		'AU091': {
			code: 'AU091',
			name: 'Fundamentos da Arquitetura I',
			ementa: 'Introdução à Arquitetura; Processos de projeto, de representação e de construção ao longo da história; Promeiros processos construtivos: Primeiras Sociedades, Origens da arquitetura monumental: Mesopotâmia e Egito; Antiguidade Clássica: arquitetura Grega e Romana; Arquitetura e arte Paleocristã e Bizantina; Idade Média: da Alta Idade Média ao Gótico; o Renascimento e os Tratados de Arquitetura; Maneirismo e Barroco; O Iluminismo e as origens do Neoclássico; Romantismo e Neoclassicismo; Arquitetura e Revolução Insdustrial; Arquitetura e arte no século XIX.',
			semestre: 1,
