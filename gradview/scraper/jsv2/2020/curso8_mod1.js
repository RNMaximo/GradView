const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['FA173', 'MA111', 'MA141', 'QG102', 'MC102', 'FA100', 'QG101']
		},
		'sem-2': {
			id: '2',
			subjects: ['ME414', 'MA211', 'FA273', 'F_129', 'FA270', 'F_128', 'BT330']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'EM306', 'F_328', 'F_329', 'FA374', 'FA370', 'FA379', 'FA373']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV323', 'EM406', 'FA474', 'FA473', 'FA470', 'FA425', 'FA481', 'FA479']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM506', 'FA585', 'FA576', 'FA564', 'FA573', 'FA586', 'FA577', 'FA983', 'FA503', 'FA520']
		},
		'sem-6': {
			id: '6',
			subjects: ['FA670', 'FA682', 'FA665', 'FA680', 'ET016', 'FA676', 'FA673', 'FA622', 'FA679']
		},
		'sem-7': {
			id: '7',
			subjects: ['FA770', 'FA782', 'FA780', 'FA778', 'FA786', 'FA721', 'FA733', 'FA779', 'FA720']
		},
		'sem-8': {
			id: '8',
			subjects: ['FA870', 'FA878', 'FA877', 'FA876', 'FA880', 'FA873', 'FA874', 'FA879']
		},
		'sem-9': {
			id: '9',
			subjects: ['FA070', 'ELET09', 'FA984', 'FA979', 'FA972']
		},
		'sem-10': {
			id: '10',
			subjects: ['FA071', 'ELET10', 'FA985']
		}
	},
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['AM030', 'EI001', 'EI002', 'EI003', 'EI004', 'FA001', 'FA002', 'FA006', 'FA016', 'FA017', 'FA018', 'FA019', 'FA021', 'FA024', 'FA026', 'FA028', 'FA030', 'FA031', 'FA032', 'FA033', 'FA041', 'FA042', 'FA043', 'FA044', 'FA050', 'FA051', 'FA052', 'FA054', 'FA059', 'FA061', 'FA062', 'FA063', 'FA066', 'FA067', 'FA068', 'FA069', 'FA073', 'FA074', 'FA075', 'FA076', 'FA081', 'FA082', 'FA083', 'FA084', 'FA085', 'FA088', 'FA090', 'FA091', 'FA093', 'FA094', 'FA095', 'FA097', 'FA099', 'FA103', 'FA105', 'FA106', 'FA107', 'FA108', 'FA109', 'FA110', 'FA111', 'FA112', 'FA113', 'FA114', 'FA115'],
		},
	},
	...
	subjects: {
		...
		'FA111': {
			...
			ementa: 'Introdução ao tratamento de esgotos, características dos esgotos, vazão de esgotos e cargas constituintes, seleção de processos, projeto e implementação, processos físicos unitários, processos químicos unitários, tratamento biológicos de esgotos, tratamento de lodo, gerenciamento de biossólidos.',
			semestre: 1,
			vector: {T:2, P:1, L:0, O:0, D:0, HS:3, SL:3, C:3},
			requisitos: ['FA874'],
			color: '#46B946',
		...
		'FA112': {
			code: 'FA112',
			name: 'Análise Espacial de Dados Aplicada à Agricultura',
			ementa: 'Obtenção de dados cartográficos, digitais e geração de produtos a partir de geotecnologias. Integração de dados espaciais. Criação de mapas para agricultura de precisão.',
			semestre: 1,
			vector: {T:0, P:2, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['FA074', 'FA665'],
			color: '#4F8F82',
			obligatory: false
		},
		'FA113': {
			code: 'FA113',
			name: 'Fundamentos em Robótica na Agricultura',
			ementa: 'Cinemática de robôs. Dinâmica de robôs. Projeto de mecanismos para aplicações robóticas. Sensoriamento. Planejamento de movimentos. Teoria de controle. Programação. Arquitetura de sistemas e Métodos em raciocínio A.I.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['FA474', 'FA573', 'FA770'],
			color: '#848986',
			obligatory: false
		},
		'FA114': {
			code: 'FA114',
			name: 'Dinâmica de Sistemas Mecânicos',
			ementa: 'Desenvolvimento das equações de movimento, estabilidade de sistemas mecânicos, trajetórias lineares e não-lineares de corpos e sistemas de referência e conceitos básicos da dinâmica computacional. Criação de modelos em linguagem simbólica MatLab.',
			semestre: 1,
			vector: {T:1, P:1, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['FA470'],
			color: '#9B906B',
		...
		'FA115': {
			...
			ementa: 'Revisão de mecânica dos sólidos. Introdução ao software Ansys. Elementos de barra e treliça. Elementos de vigas e pórticos. Elementos Bidimensionais. Modelagem e técnicas de solução. Elementos tridimensionais.',
			semestre: 1,
			vector: {T:1, P:0, L:1, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['EM506'],
			color: '#B97A7A',
