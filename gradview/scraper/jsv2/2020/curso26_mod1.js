const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['AC218', 'AC133', 'AC316', 'AC110', 'AC129', 'AC109', 'AC115', 'AC134']
		},
		'sem-2': {
			id: '2',
			subjects: ['AC215', 'AC234', 'AC315', 'AC210', 'AC214', 'AC209', 'AC211', 'AC233']
		},
		'sem-3': {
			id: '3',
			subjects: ['AC334', 'AC340', 'AC415', 'AC331', 'AC105', 'AC333', 'AC890']
		},
		'sem-4': {
			id: '4',
			subjects: ['AC440', 'AC441', 'AC317', 'AC205', 'AC120', 'AC414', 'AC434']
		},
		'sem-5': {
			id: '5',
			subjects: ['AC555', 'AC321', 'AC160', 'AC557']
		},
		'sem-6': {
			id: '6',
			subjects: ['AC260', 'AC666', 'AC657', 'AC121']
		},
		'sem-7': {
			id: '7',
			subjects: ['AC757', 'AC360', 'AC777', 'ELET07']
		},
		'sem-8': {
			id: '8',
