const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV101', 'MA141', 'CV111', 'CV141', 'MA111', 'CV151', 'QG102', 'MC102']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV201', 'MA327', 'MA211', 'CV202', 'ME414', 'GM420', 'F_129', 'F_128']
		},
		'sem-3': {
			id: '3',
			subjects: ['MA311', 'CV321', 'CV312', 'CV332', 'MS211', 'CV351', 'CV301', 'F_229']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV402', 'CV411', 'F_329', 'CV431', 'CV401', 'CV421', 'F_328', 'CV450', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV501', 'CV511', 'CV532', 'ELET05', 'CV521', 'CV522', 'CV541', 'CV531']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV631', 'CV612', 'CV613', 'CV633', 'CV622', 'CV621', 'CV641', 'CV632', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV713', 'CV712', 'CV714', 'CV701', 'CV721', 'CV702', 'CV722', 'CV741']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV814', 'CV813', 'CV812', 'CV823', 'CV811', 'CV821', 'CV831', 'CV832', 'ELET08', 'CV822', 'CV841']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV912', 'CV916', 'CV911', 'CV954', 'ELET09']
		},
		'sem-10': {
			id: '10',
