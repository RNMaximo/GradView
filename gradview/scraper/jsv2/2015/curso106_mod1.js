const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['GL604', 'NC103', 'GL101', 'GL100', 'NC400']
		},
		'sem-2': {
			id: '2',
			subjects: ['NC100', 'ELET02', 'GL202', 'GL201', 'GL203']
		},
		'sem-3': {
			id: '3',
			subjects: ['GL302', 'NC301', 'GL600', 'GL301', 'GL300']
		},
		'sem-4': {
			id: '4',
			subjects: ['GL200', 'LE702', 'GL603', 'GL400', 'LE803', 'GL403']
		},
		'sem-5': {
			id: '5',
			subjects: ['GL501', 'GL505', 'GL506', 'GL502', 'ELET05', 'GL504']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL602', 'GL606', 'GL605', 'GL607', 'ER200', 'GL601', 'GL900']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL700', 'GL701', 'PG704', 'PG701', 'PG703', 'ELET07', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['GL801', 'GL800', 'PG801', 'ELET08', 'PG809', 'PG802']
		}
	},
