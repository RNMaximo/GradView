const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['F_128', 'MA141', 'QG101', 'MA111', 'TA109']
		},
		'sem-2': {
			id: '2',
		...
		'sem-4': {
			id: '4',
			subjects: ['TA322', 'BM320', 'TA411', 'TA332', 'TA331']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA421', 'TA516', 'TA431', 'TA514', 'TA513']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA521', 'TA620', 'TA534', 'TA615', 'TA610']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA722', 'TA622', 'MS211', 'TA631', 'TA716', 'ME414']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA826', 'TA824', 'TA731', 'TA611', 'TA724', 'TA619', 'CE138']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA920', 'TA927', 'TA831', 'TA912', 'TA623', 'TA541', 'TA542']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA641', 'F_328', 'TA035', 'TA734']
		},
		'sem-11': {
			id: '11',
			subjects: ['TA030', 'ET016', 'TA736', 'TA836', 'TA741', 'TA832']
		},
		'sem-12': {
			id: '12',
			subjects: ['TA909', 'TA737', 'TA017', 'TA046', 'TA023', 'TA009', 'TA932']
		}
	},
