const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['NC400', 'NC103', 'GL100', 'PG100', 'GL101']
		},
		'sem-2': {
			id: '2',
			subjects: ['GL302', 'GL203', 'GL201', 'PG200', 'PG201']
		},
		'sem-3': {
			id: '3',
			subjects: ['NC301', 'PG300', 'GL301', 'PG301', 'GL202']
		},
		'sem-4': {
			id: '4',
			subjects: ['ER201', 'ER401', 'GL400', 'PG400', 'GL603', 'PG800']
		},
		'sem-5': {
			id: '5',
			subjects: ['PG502', 'PG704', 'PG500', 'PG501', 'GL502']
		},
		'sem-6': {
			id: '6',
			subjects: ['GL608', 'PG600', 'PG801', 'GL900', 'PG701', 'NC100']
		},
		'sem-7': {
			id: '7',
			subjects: ['GL601', 'ELET07', 'GL701', 'GL700', 'PG710', 'PG709']
		},
		'sem-8': {
			id: '8',
			subjects: ['ELET08', 'PG810', 'GL801', 'GL800']
		}
	},
