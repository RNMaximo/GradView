const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG100', 'EM110', 'F_128', 'MA141', 'EM102', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['EM240', 'EM103', 'F_328', 'MA211', 'EM306', 'EM200', 'F_129', 'ME414']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_428', 'EM360', 'EM335', 'MA311', 'EM330', 'MC102', 'F_329']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM641', 'EM460', 'EM461', 'EM406', 'EM404', 'MS211', 'MA327', 'F_429']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM737', 'EM014', 'EM561', 'EM570', 'EM503', 'EM504', 'EM638', 'EM506']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM665', 'EM535', 'EM670', 'EM733', 'ET017', 'EM909', 'EM607']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM730', 'EM833', 'EM884', 'EM783', 'EM853', 'EM608', 'EM703', 'EM707']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM740', 'ELET08', 'EM984', 'BE310', 'EM790', 'CE738', 'EM807']
		},
		'sem-9': {
			id: '9',
			subjects: ['CE304', 'EM914', 'EM928', 'EM926']
		},
		'sem-10': {
			id: '10',
