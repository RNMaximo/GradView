const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC001', 'CS107', 'CS102', 'CS100', 'CS103', 'CS104', 'CS106']
		},
		'sem-2': {
			id: '2',
			subjects: ['CS204', 'CS205', 'CS203', 'CS206', 'CS200', 'CS202']
		},
		'sem-3': {
			id: '3',
			subjects: ['CS301', 'CS303', 'CS052', 'CS039', 'CS300', 'CS302', 'CS304']
		},
		'sem-4': {
			id: '4',
			subjects: ['ELET04', 'CS040', 'CS402', 'CS401', 'CS404', 'CS400', 'CS405']
		},
		'sem-5': {
			id: '5',
			subjects: ['CS508', 'CS500', 'ELET05', 'CS601']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06']
	...
	eletivas: {
		...
		'elet-2': {
			credits: 34,
			hasRestrictions: true,
			subjects: ['AR130', 'CS007', 'CS009', 'CS011', 'CS014', 'CS015', 'CS017', 'CS018', 'CS020', 'CS025', 'CS026', 'CS027', 'CS028', 'CS029', 'CS030', 'CS031', 'CS032', 'CS033', 'CS034', 'CS035', 'CS036', 'CS037', 'CS038', 'CS043', 'CS049', 'CS054', 'CS055', 'CS059', 'CS305', 'CS504', 'CS505', 'CS506', 'CS507', 'CS800', 'CS801'],
		},
		'elet-3': {
			credits: 12,
