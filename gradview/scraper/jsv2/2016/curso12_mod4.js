const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV111', 'MA141', 'CV141', 'MA111', 'QG102', 'MC102', 'CV101', 'CV151']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_129', 'F_128', 'MA211', 'CV202', 'ME414', 'GM420', 'CV201']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_229', 'CV312', 'CV301', 'CV311', 'MS211', 'CV332', 'CV351', 'CV321']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV411', 'F_328', 'CV431', 'F_329', 'CV401', 'CV402', 'CV450', 'CV421', 'CV422']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'CV511', 'CV532', 'CV541', 'CV531', 'CV501', 'CV521', 'CV522']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV613', 'CV612', 'ELET06', 'CV641', 'CV633', 'CV632', 'CV621', 'CV622', 'CV631']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV712', 'CV713', 'CV741', 'CV714', 'CV701', 'CV721', 'CV702', 'CV722']
		},
		'sem-8': {
			id: '8',
			subjects: ['CV814', 'CV841', 'CV813', 'ELET08', 'CV812', 'CV811', 'CV832', 'CV823', 'CV822', 'CV821', 'CV831']
		},
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'CV945', 'CV941', 'CV942', 'CV951']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV955', 'ELET10', 'CV943', 'CV944']
		}
	},
