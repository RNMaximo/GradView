const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['MC102', 'MA111', 'QG101', 'MA141', 'TA109', 'F_128']
		},
		'sem-2': {
			id: '2',
			subjects: ['QF331', 'MA211', 'TA221', 'QA213', 'QO427', 'F_228']
		},
		'sem-3': {
			id: '3',
			subjects: ['TA331', 'TA332', 'MA311', 'F_328', 'BM320', 'TA322']
		},
		'sem-4': {
			id: '4',
			subjects: ['CE138', 'MS211', 'ME414', 'ET016', 'TA411', 'TA421', 'TA431']
		},
		'sem-5': {
			id: '5',
			subjects: ['TA542', 'TA514', 'TA521', 'TA541', 'TA516', 'TA513', 'TA534']
		},
		'sem-6': {
			id: '6',
			subjects: ['TA610', 'TA615', 'TA611', 'TA641', 'TA620', 'TA622', 'TA631', 'TA619']
		},
		'sem-7': {
			id: '7',
			subjects: ['TA017', 'TA731', 'TA824', 'TA726', 'TA722', 'TA734', 'TA623', 'TA716', 'TA737']
		},
		'sem-8': {
			id: '8',
			subjects: ['TA832', 'TA736', 'TA030', 'TA729', 'TA826', 'TA831', 'TA920', 'TA836', 'TA725']
		},
		'sem-9': {
			id: '9',
			subjects: ['TA932', 'TA912', 'TA927', 'TA741', 'TA035']
		},
		'sem-10': {
			id: '10',
			subjects: ['TA046', 'TA009', 'TA021', 'TA909']
		}
	},
