const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EM110', 'EM102', 'QG100', 'EM330', 'MA141', 'F_128', 'MA111']
		},
		'sem-2': {
			id: '2',
			subjects: ['ELET02', 'EM200', 'EM335', 'EM240', 'MA211', 'F_328', 'F_129']
		},
		'sem-3': {
			id: '3',
			subjects: ['EM440', 'MC102', 'EM306', 'MA311', 'EM360', 'F_428', 'F_329']
		},
		'sem-4': {
			id: '4',
			subjects: ['EM103', 'EM461', 'EM406', 'EM404', 'MS211', 'EM460', 'MA327', 'F_429']
		},
		'sem-5': {
			id: '5',
			subjects: ['EM503', 'EM535', 'EM561', 'EM570', 'EM504', 'EM506', 'ME414']
		},
		'sem-6': {
			id: '6',
			subjects: ['EM641', 'EM733', 'EM607', 'EM638', 'EM670', 'ELET06', 'EM833', 'ET016']
		},
		'sem-7': {
			id: '7',
			subjects: ['EM740', 'EM707', 'EM703', 'EM730', 'EM731', 'EM867', 'EM783', 'EM884', 'EM965']
		},
		'sem-8': {
			id: '8',
			subjects: ['EM203', 'EM807', 'EM886', 'EM853', 'EM984', 'EM608', 'EM074', 'CE738', 'BE310']
		},
		'sem-9': {
			id: '9',
			subjects: ['EM914', 'CE304', 'EM790', 'EM866', 'EM909', 'EM806', 'EM865']
		},
		'sem-10': {
			id: '10',
			subjects: ['EM919', 'EM868', 'EM916']
		}
	},
	...
	subjects: {
		...
		'EM965': {
			code: 'EM965',
			name: 'Tópicos em Engenharia Automobilística',
			ementa: 'Ementa variável. Seminários sobre tópicos específicos em engenharia automobilística: Novas tecnologias e métodos utilizados em engenharia automobilística. Novos produtos e equipamentos. Processos especiais. Tópicos complementares em engenharia automobilística.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: ['AA470'],
			color: '#6046B9',
