const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['ME639', 'ME100', 'MA111', 'MA141', 'ME110', 'ME111']
		},
		'sem-2': {
			id: '2',
			subjects: ['LA122', 'ME210', 'MA211', 'MA327', 'MC102']
		},
		'sem-3': {
			id: '3',
			subjects: ['LA222', 'ME310', 'ME319', 'MA311', 'MC202']
		},
		'sem-4': {
			id: '4',
			subjects: ['ME501', 'ME419', 'ME430', 'MS211', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['ME623', 'ME613', 'ME524', 'MS512', 'ELET05']
		},
		'sem-6': {
			id: '6',
			subjects: ['ME610', 'ME607', 'ME731', 'ME651', 'ELET06']
		},
		'sem-7': {
			id: '7',
			subjects: ['ME710', 'ME714', 'ELET07']
		},
		'sem-8': {
			id: '8',
	...
	eletivas: {
		'elet-1': {
			...
			subjects: ['BB125', 'CE138', 'CE451', 'CE738', 'CE939', 'EU502', 'MA044', 'MA502', 'MA602', 'MC---', 'ME502', 'ME601', 'ME612', 'ME630', 'ME652', 'ME661', 'ME701', 'ME705', 'ME706', 'ME715', 'ME716', 'ME721', 'ME730', 'ME732', 'ME850', 'MS317', 'MS428', 'MS515', 'MS580', 'MS614', 'MS680', 'MS714', 'MS715', 'TA712'],
		},
		'elet-2': {
			credits: 12,
	...
	subjects: {
		...
		'LA222': {
			...
			ementa: 'Leitura de textos em inglês em grau mais avançado de dificuldade, visando explorar estruturas linguísticas mais complexas e procedimentos interpretativos.',
			semestre: 1,
			vector: {T:2, P:2, L:0, O:0, D:0, HS:4, SL:4, C:4},
			requisitos: ['AA200'],
			color: '#B94667',
