const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['TL118', 'HL121', 'TL222', 'LG021', 'HL127', 'LA104', 'HL143']
		},
		'sem-2': {
			id: '2',
			subjects: ['HL220', 'HL236', 'LA204', 'ELET02', 'LG022']
		},
		'sem-3': {
			id: '3',
			subjects: ['HL323', 'ELET03', 'LG023', 'LA303']
		},
		'sem-4': {
			id: '4',
			subjects: ['HL422', 'ELET04', 'LA403', 'LG024']
		},
		'sem-5': {
			id: '5',
			subjects: ['LG025', 'ELET05', 'LA501', 'HL135']
		},
		'sem-6': {
			id: '6',
	...
	subjects: {
		...
		'TL153': {
			code: 'TL153',
			name: 'Tópicos XV: Textos em Prosa de Fic- ção IV',
			ementa: 'Será divulgada por ocasião do oferecimento da disciplina.',
			semestre: 1,
			vector: {T:2, P:0, L:0, O:0, D:0, HS:2, SL:2, C:2},
			requisitos: '',
