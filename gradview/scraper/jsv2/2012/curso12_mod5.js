const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['CV141', 'QG102', 'CV111', 'MA111', 'MA141', 'CV101', 'MC102', 'CV151']
		},
		'sem-2': {
			id: '2',
			subjects: ['CV202', 'GM420', 'F_129', 'MA211', 'F_128', 'ME203', 'CV201']
		},
		'sem-3': {
			id: '3',
			subjects: ['CV332', 'F_229', 'CV311', 'CV301', 'CV351', 'CV312', 'MS211', 'CV321']
		},
		'sem-4': {
			id: '4',
			subjects: ['CV450', 'CV422', 'F_329', 'CV401', 'F_328', 'CV411', 'CV431', 'CV421', 'CV402']
		},
		'sem-5': {
			id: '5',
			subjects: ['CV521', 'ELET05', 'CV541', 'CV511', 'CV522', 'CV532', 'CV531', 'CV501']
		},
		'sem-6': {
			id: '6',
			subjects: ['CV633', 'CV621', 'CV613', 'CV612', 'ELET06', 'CV641', 'CV632', 'CV622', 'CV631']
		},
		'sem-7': {
			id: '7',
			subjects: ['CV721', 'CV713', 'CV714', 'CV712', 'CV701', 'CV741', 'CV702', 'CV722']
		},
		'sem-8': {
			id: '8',
		...
		'sem-9': {
			id: '9',
			subjects: ['CV954', 'CV951', 'CV922', 'CV921']
		},
		'sem-10': {
			id: '10',
			subjects: ['CV955', 'CV923', 'ELET10']
		}
	},
