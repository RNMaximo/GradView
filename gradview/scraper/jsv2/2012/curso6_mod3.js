const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['EL211', 'F_107', 'BC180', 'BT380', 'BZ182', 'QG107', 'BE180']
		},
		'sem-2': {
			id: '2',
			subjects: ['BG280', 'BB280', 'BH282', 'BT280', 'EL683', 'BZ280', 'BA280']
		},
		'sem-3': {
			id: '3',
			subjects: ['BG380', 'BI381', 'BM382', 'BT480', 'EL511', 'BZ380', 'BV381', 'ELET03']
		},
		'sem-4': {
			id: '4',
			subjects: ['BG480', 'MS380', 'BH484', 'BF482', 'BZ480', 'GM280', 'BE480']
		},
		'sem-5': {
			id: '5',
			subjects: ['ELET05', 'ME480', 'BF582', 'BP480']
		},
		'sem-6': {
			id: '6',
			subjects: ['GM450', 'ELET06', 'BF682']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07', 'EL876', 'EL774']
		},
		'sem-8': {
			id: '8',
			subjects: ['EL885', 'ELET08', 'BT681']
		}
	},
	...
	eletivas: {
		...
		'elet-4': {
			credits: 16,
			hasRestrictions: true,
			subjects: ['BB583', 'BC081', 'BE082', 'BG081', 'BP081', 'BT080', 'BZ083', 'GM082'],
		},
		'elet-5': {
			credits: 8,
			hasRestrictions: true,
