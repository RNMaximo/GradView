const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['F_128', 'F_129', 'MA141', 'MA111', 'MS149', 'FM003']
		},
		'sem-2': {
			id: '2',
			subjects: ['F_228', 'F_229', 'MA327', 'MA211', 'MC102']
		},
		'sem-3': {
			id: '3',
			subjects: ['F_328', 'F_329', 'MS211', 'MA311', 'ME210']
		},
		'sem-4': {
			id: '4',
			subjects: ['MS328', 'MA044', 'F_315', 'MS428', 'ME310']
		},
		'sem-5': {
			id: '5',
			subjects: ['MA502', 'MS550', 'MS512', 'MC202']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'MS650', 'MS629']
		},
		'sem-7': {
			id: '7',
			subjects: ['ELET07']
	...
	subjects: {
		...
		'MS550': {
			...
			ementa: 'Revisão de equações diferenciais: equações da Física Matemática; sistemas de coordenadas. Existências e unicidade da solução das equações diferenciais ordinárias. Pontos singulares regulares: método de Frobenius. Funções especiais (Bessel, Legendre). Equações Fuchsianas; Função Hipergeométrica. Sistemas de Sturm-Liouville. Polinômios ortogonais. Expansão em autofunções: séries de Fourier, séries generalizadas.',
			semestre: 1,
			vector: {T:4, P:2, L:0, O:0, D:0, HS:6, SL:6, C:6},
		...
		'MS650': {
			...
			ementa: 'Transformadas integrais (Fourier e Laplace). Transformadas inversas. Representação integral de funções. Equações diferenciais parciais. Classificação; problemas bem-postos. Equações da onda, do calor e de Laplace. Método de separação de variáveis. Aplicações com uso de coordenadas cartesianas, esféricas e cilíndricas.',
			semestre: 1,
			vector: {T:4, P:2, L:0, O:0, D:0, HS:6, SL:6, C:6},
			requisitos: ['*MS550'],
			color: '#B95555',
		...
		'MS777': {
			...
			ementa: 'Desenvolvimento de um projeto de pesquisa em matemática aplicada, sob a supervisão de um professor, resultando em um relatório técnico.',
			semestre: 1,
