const catalogue = {
	...
	semesters: {
		'sem-1': {
			id: '1',
			subjects: ['QG108', 'QA112', 'QG109', 'MA141', 'MA111', 'QG362', 'QG005']
		},
		'sem-2': {
			id: '2',
			subjects: ['QO321', 'QA217', 'MA211', 'F_128', 'LA122', 'F_129', 'EL683']
		},
		'sem-3': {
			id: '3',
			subjects: ['QO521', 'QA412', 'MA311', 'F_328', 'EL511', 'F_329']
		},
		'sem-4': {
			id: '4',
			subjects: ['QF431', 'EL211', 'QI246', 'F_428', 'ELET04']
		},
		'sem-5': {
			id: '5',
			subjects: ['QF531', 'QG565', 'GM861', 'EL774']
		},
		'sem-6': {
			id: '6',
			subjects: ['ELET06', 'QO625', 'QF535', 'QG680']
		},
		'sem-7': {
			id: '7',
			subjects: ['QO551', 'QG760', 'QF732', 'EL874', 'ELET07']
		},
		'sem-8': {
			id: '8',
			subjects: ['QF661', 'QL701', 'QA815', 'QG880', 'ELET08']
		}
	},
	...
	subjects: {
		...
		'QA412': {
			code: 'QA412',
			name: 'Fundamentos de Análise Instrumental',
			ementa: 'Introdução aos métodos espectroanalíticos, eletroanalíticos e de separação.',
			semestre: 1,
		...
		'QO625': {
			...
			ementa: 'Análise orgânica qualitativa. Solubilidade. Pontos de fusão e de ebulição. Testes de caracterização. Reações de grupos funcionais. Análise de amostras desconhecidas. Obtenção de derivados.',
			semestre: 1,
